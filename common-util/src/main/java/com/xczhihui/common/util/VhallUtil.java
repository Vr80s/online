...
import com.xczhihui.common.util.bean.Webinar;
...
public class VhallUtil {
     ...
     **/
    public static String createUser(String userId, String name, String headPhoto, String password) {
     ...
     * @author name：yuxin <br>email: yuruixin@ixincheng.com
     **/
    public static String updateUser(String userId, String name, String headPhoto, String password) {
        Map<String, String> parameters = new TreeMap<String, String>();
		/* 公共参数 */
        parameters.put("auth_type", AUTO_TYPE);
        parameters.put("account", ACCOUNT);
