...
public final class ImageUtil {
     ...
     * 裁剪图片，裁剪后的图片为png格式。
     *
     * @param inPath  源路径(包含图片)
     * @param outPath 目标路径 null则默认为源路径
     * @param width   剪切宽度
     * @param height  剪切高度
     */
     ...
     * 裁剪图片，裁剪后的图片为png格式。
     *
     * @param imageInputStream  要裁剪的图片输入流
     * @param imageOutputStream 裁剪后的图片输出流
     ...
     * 缩放图片
     *
     * @param inputImage 源路径(包含图片)
     * @param outImage   缩放后的图片保存位置
     * @param width      缩放后宽度
     * @param height     缩放后高度
     */
     ...
     * 缩放图片
     *
     * @param imageInputStream  要缩放的图片输入流
     * @param imageOutputStream 缩放后的图片输出流
     * @param format            图片格式，如：png jpg
     * @param width             缩放后宽度
     * @param height            缩放后高度
     */
