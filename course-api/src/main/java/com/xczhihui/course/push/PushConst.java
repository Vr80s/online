...
public class PushConst {
    ...
    public static final String IOS_SOUND_FILE = "beep.wav";
    /**
     * 安卓通知类型
     */
    public static final int MESSAGE_TYPE_ANDROID_NOTIFICATION = 1;
    /**
     * 安卓透传
     */
    public static final int MESSAGE_TYPE_ANDROID_UT_MESSAGE = 2;
    /**
     * IOS
     */
    public static final int MESSAGE_TYPE_IOS = 0;

    public static final String TITLE = "熊猫中医";
}
