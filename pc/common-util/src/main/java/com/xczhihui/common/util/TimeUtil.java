...
public class TimeUtil {
    ...
    public static boolean isTomorrow(Date time) {
        ...
        int todayYearVal = calendar.get(Calendar.YEAR);
        int todayDayOfYearVal = calendar.get(Calendar.DAY_OF_YEAR);

        calendar.setTime(time);

        return todayYearVal == calendar.get(Calendar.YEAR) && calendar.get(Calendar.DAY_OF_YEAR) - todayDayOfYearVal == 1;
    }

    public static String getHourMonth(Date time) {
        SimpleDateFormat simpleDateFormat = new SimpleDateFormat("HH:mm");
        return simpleDateFormat.format(time);
    }

    public static String getYearMonthDayHHmm(Date time) {
