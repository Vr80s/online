 ...
 */
@Repository("simpleHibernateDao2")
public class SimpleHibernateDao2 {
	 ...
	 * @return
	 */
	public <T extends BasicEntity2> int deleteLogics(Class<T> clazz, List<String> ids) {
	 ...
	 * @return
	 */
	public <T extends BasicEntity2> int updateDeletes(Class<T> clazz, List<String> ids, boolean isDelete) {
	 ...
	 * @param clazz
	 */
	public <T extends BasicEntity2> T deleteLogic(Serializable id, Class<T> clazz) {
	 ...
	 * @param clazz
	 */
	public <T extends BasicEntity2> void deleteLogic(BasicEntity2 entity) {
	 ...
	 * @param isDelete
	 */
	public <T extends BasicEntity2> T updateDelete(Serializable id, Class<T> clazz, boolean isDelete) {
	 ...
	 * @param isDelete
	 */
	public <T extends BasicEntity2> void updateDelete(BasicEntity2 entity, boolean isDelete) {
	 ...
	 * @return
	 */
	public <T extends BasicEntity2> T getValid(Serializable id, Class<T> clazz) {
		DetachedCriteria dc = DetachedCriteria.forClass(clazz);
