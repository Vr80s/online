...
public class EnchashmentManagerController {
	...
	public String index(HttpServletRequest request) {
		List<EnchashmentDismissal> enchashmentDismissals = EnchashmentDismissal
				.getDismissalList();
	...
	public TableVo findEnchashmentList(TableVo tableVo) {
		...
		if (orderStatusGroup != null) {
			searchVo.setStatus(Integer.parseInt(orderStatusGroup
		...
		if (anthorTypeGroup != null) {
			searchVo.setAnthorType(Integer.valueOf(anthorTypeGroup
					.getPropertyValue1().toString()));
		}

		Page<EnchashmentApplyInfo> page = enchashmentService
				.findEnchashmentPage(searchVo, currentPage, pageSize);
	...
	@ResponseBody
	public ResponseObject handleEnchashment(String id, int status,
			Integer dismissal, String dismissalRemark) throws ParseException {
