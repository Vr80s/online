...
public class GiftStatementController extends AbstractController {
    ...
    public TableVo gifts(TableVo tableVo) {
        ...
        if (clientTypeGroup != null && StringUtils.isNotBlank(clientTypeGroup.getPropertyValue1().toString())) {
            searchVo.setClientType(Integer.parseInt(clientTypeGroup.getPropertyValue1().toString()));
        }
