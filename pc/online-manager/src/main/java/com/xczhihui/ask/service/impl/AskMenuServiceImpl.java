 ...
 */
@Service
public class AskMenuServiceImpl extends OnlineBaseServiceImpl implements
		AskMenuService {
	...
	public Page<MenuVo> findMenuPage(MenuVo menuVo, Integer pageNumber,
			Integer pageSize) {
		Page<MenuVo> page = askMenuDao.findCloudClassMenuPage(menuVo,
				pageNumber, pageSize);
		return page;
	}
	...
	public List<MenuVo> list() {
		...
		List<MenuVo> voList = askMenuDao.findEntitiesByJdbc(MenuVo.class, sql,
				params);
		return voList;
	}
	...
	public void updateChildrenMenuDirectionUp(String pid, String id,
		...
		Menu preMenu = askMenuDao.updateDirectionUp(parentMenu.getNumber(),
	...
	public void updateChildrenMenuDirectionDown(String pid, String id,
			Integer level) {
		Menu parentMenu = askMenuDao.findById(Integer.parseInt(pid));
		Menu downMenu = askMenuDao.updateDirectionDown(parentMenu.getNumber(),
				Integer.parseInt(id), level);
		Menu me = askMenuDao.findById(Integer.parseInt(id));
		Integer meSort = me.getBoSort();
		me.setBoSort(downMenu.getBoSort());
