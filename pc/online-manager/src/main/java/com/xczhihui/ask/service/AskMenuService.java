...
/**
 * AskMenuService:博问答学科管理业务层接口类 * @author yxd
 */
public interface AskMenuService {

	// public List<MenuVo> getAllMenu(String name, Integer pageNumber, Integer
	// pageSize);
	...
	void updateAskMenuLimit(MenuVo menu);
