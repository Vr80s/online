...
public class PermResourceController extends AbstractController {
	...
	public String index(HttpServletRequest request) {
		List<SystemVariate> resourceTypes = this.resourceService
				.getResourceTypes();// 权限资源类型
	...
	@ResponseBody
	public List<Resource> list(HttpServletRequest request)
		...
		List<Resource> resources = this.resourceService.getHierarchyResources(
				type, isValid);
		return resources;
	}
	...
	public ResponseObject add(Resource resource) {
		resource.setCreatePerson(ManagerUserUtil.getId());
	...
	@ResponseBody
	public List<ZtreeVo> roleTree(HttpServletRequest request)
			throws ServletRequestBindingException {
		String roleId = ServletRequestUtils.getRequiredStringParameter(request,
				"roleId");
		List<ZtreeVo> ztreeVos = this.resourceService
				.findRoleResourceTree(roleId);
		return ztreeVos;
	}
	...
	@ResponseBody
	public String isUsing(HttpServletRequest request)
			throws ServletRequestBindingException {
		String resourceId = ServletRequestUtils.getRequiredStringParameter(
				request, "resourceId");
