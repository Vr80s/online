...
import com.xczhihui.course.dao.QuestionDao;
...
import com.xczhihui.course.service.QuestionService;
				...
				if (q.getQuestionType() == 5 || q.getQuestionType() == 6) {
					...
					if (StringUtils.isNotBlank(name)) {
						Attachment attachment = attachmentCenterService
						        .addAttachment(ManagerUserUtil.getId(),AttachmentType.QUESTION, name,zipMap.get(name), "zip",ticket);
