...
public class GradeController {
    ...
    //@RequiresPermissions("course:menu:grade:teachmethod:list")
    ...
    //@RequiresPermissions("course:menu:grade:course:list")
     ...
     * @return
     */
    //@RequiresPermissions("course:menu:grade")
...
//    	}
     ...
     * @return
     */
    //@RequiresPermissions("course:menu:grade:teachers")
     ...
     * @return
     */
    //@RequiresPermissions("course:menu:grade:new:save")
...
//        grade.setDefaultStudentCount(Integer.valueOf(defaultStudentCount));
     ...
     * @return
     */
    //@RequiresPermissions("course:menu:grade:new:update")
