...
import com.xczhihui.course.dao.TeachMethodDao;
import com.xczhihui.course.service.TeachMethodService;
 ...
 */
@Service
public class TeachMethodServiceImpl extends OnlineBaseServiceImpl implements TeachMethodService {

    @Autowired
    private TeachMethodDao teachMethodDao;

	@Override
	public Page<TeachMethodVo> findTeachMethodPage(TeachMethodVo teachMethodVo, Integer pageNumber, Integer pageSize) {
		Page<TeachMethodVo> page = teachMethodDao.findTeachMethodPage(teachMethodVo, pageNumber, pageSize);
        return page;
	}

	@Override
	public List<TeachMethod> findTeachMethodByName(String name) {
		return teachMethodDao.findEntitiesByProperty(TeachMethod.class,"name",name);
	}
	...
	public List<TeachMethodVo> list() {
		...
		List<TeachMethodVo> voList=teachMethodDao.findEntitiesByJdbc(TeachMethodVo.class, sql, params);
		return voList;
	}
	...
	public TeachMethod findByCourseId(String courseId) {
		...
		List<TeachMethod> teachMethodList=teachMethodDao.findEntitiesByJdbc(TeachMethod.class, sql, params);
