...
public class LecturerController {
	...
	//@RequiresPermissions("course:menu:lecturer")
	@RequestMapping(value = "index")
	public String index(HttpServletRequest request) {
		List<Menu> menuVos= lecturerService.getfirstMenus();
		request.setAttribute("menuVo", menuVos);
		List<SystemVariate> roles = systemVariateService.getSystemVariatesByParentValue("role_type");
	...
	public TableVo Lecturers(TableVo tableVo) {
          ...
          Page<LecturerVo> page = lecturerService.findLecturerPage(searchVo, currentPage, pageSize);
	 ...
	 */
	 ...
	 public List<LecturerVo> findTeachRecordsByLecturerId(String id){
		 List<LecturerVo> LecturerVos = lecturerService.findTeachRecordsByLecturerId(id);
		 return LecturerVos;
	 }
