...
public class DoctorApplyServiceImpl implements DoctorApplyService {
	 ...
	 * 
	 * @param authenticationInformationId
	 *            medical_doctor_authentication_information表主键
	 * @param apply
	 *            认证信息的封装
	 * @param type
	 *            新增数据的类型（1：系统生成 2:管理员认证）
	 * @param createTime
	 *            创建时间
	 */
	 ...
	 *            medical_doctor表的主键
	 * @param authenticationInformationId
	 *            medical_doctor_authentication_information表的主键
	 * @param apply
	 *            用户提交的认证信息封装
	 * @param type
	 *            新增类型（1：系统生成 2:管理员认证）
