 ...
 */
@Repository
public class DoctorApplyDepartmentDao extends
		HibernateDao<MedicalDoctorApplyDepartment> {
	...
	public List<MedicalDoctorApplyDepartment> findByApplyId(String applyId) {
		...
		List<MedicalDoctorApplyDepartment> result = this
				.getNamedParameterJdbcTemplate()
				.query(hql,
						paramsMap,
						BeanPropertyRowMapper
								.newInstance(MedicalDoctorApplyDepartment.class));
