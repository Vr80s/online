...
public class HospitalAccountDao extends HibernateDao<MedicalHospitalAccount> {
    ...
    public MedicalHospitalAccount findByAccountId(String userId) {
        ...
        List<MedicalHospitalAccount> result = this.getNamedParameterJdbcTemplate().query(hql, paramsMap, BeanPropertyRowMapper.newInstance(MedicalHospitalAccount.class));
