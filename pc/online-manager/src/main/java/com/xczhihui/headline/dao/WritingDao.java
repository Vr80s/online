...
public class WritingDao extends HibernateDao<ArticleVo> {
	...
	public Page<MedicalWritings> findCloudClassCoursePage(WritingVo articleVo,
			int currentPage, int pageSize) {
		// TODO Auto-generated method stub
		Map<String, Object> paramMap = new HashMap<String, Object>();

		StringBuilder sql = new StringBuilder(
				"SELECT mw.*,oba.comment_sum as commentSum  ,\n"
		...
		Page<MedicalWritings> page = this.findPageBySQL(sql.toString(),
				paramMap, MedicalWritings.class, currentPage, pageSize);
		return page;
	}
