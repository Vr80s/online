 ...
 */
@Service
public class MobilePartnerCourseServiceImpl extends SimpleHibernateDao
		implements MobilePartnerCourseService {
	...
	public MobilePartnerCourseVo findCourseInfoByCourseId() {
		...
		List<MobilePartnerCourseVo> list = this.findEntitiesByJdbc(
				MobilePartnerCourseVo.class, sql, params);
