...
public class Banner2Dao extends SimpleHibernateDao {
	...
	public Page<Banner2Vo> findBanner2Page(Banner2Vo banner2Vo, int pageNumber, int pageSize){
		   ...
		   if(banner2Vo.getDescription() != null && banner2Vo.getDescription() != "")
		   {
		   ...
		   Page<Banner2Vo> ms = this.findPageBySQL(sql.toString(), paramMap, Banner2Vo.class, pageNumber, pageSize);
      	   return ms;
	}
}
