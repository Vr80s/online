...
public class InformationController {
	...
	public ModelAndView index(HttpServletRequest request) {
		...
		List<SystemVariate> informationTypes = systemVariateService
				.getSystemVariatesByParentValue("informationType");
	...
	public TableVo findQuestionList(TableVo tableVo) {
		...
		Group informationTypeSearch = groups
				.findByName("informationTypeSearch");
		...
		if (informationTypeSearch != null) {
			searchVo.setInformationtype(informationTypeSearch
					.getPropertyValue1().toString());
		}
		if (statusSearch != null) {
			searchVo.setStatus(Integer.parseInt(statusSearch
					.getPropertyValue1().toString()));
		}
		...
		// }
		Page<InformationVo> page = informationService.findInformationPage(
	...
	public ResponseObject getTypes(Integer id) {
		return ResponseObject.newSuccessResponseObject(systemVariateService
				.getSystemVariatesByParentValue("informationType"));
	}
