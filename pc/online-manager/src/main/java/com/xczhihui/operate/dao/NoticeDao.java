...
public class NoticeDao extends SimpleHibernateDao {
	...
	public Page<NoticeVo> findNoticePage(NoticeVo noticeVo, Integer pageNumber, Integer pageSize){
		   ...
		   if(noticeVo.getNoticeContent() != null && !"".equals(noticeVo.getNoticeContent())){
		   ...
		   Page<NoticeVo> ms = this.findPageBySQL(sql.toString(), paramMap, NoticeVo.class, pageNumber, pageSize);
      	   return ms;
	}
}
