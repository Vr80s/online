...
public class ScoreTypeController {
     ...
     public ModelAndView index(){
          ModelAndView mav=new ModelAndView("cloudClass/scoreType1");
          return mav;
     }
...
//          }
          ...
          if(typeGroup!=null){
        	  searchVo.setStatus(Integer.valueOf(typeGroup.getPropertyValue1().toString()));
          }
     ...
     *//**
     ...
     public ResponseObject add(ScoreTypeVo scoreTypeVo) throws InvocationTargetException, IllegalAccessException {
    	 ResponseObject responseObj = new ResponseObject();
          ...
          entity.setStatus(0);
          entity.setType(scoreTypeVo.getType());
          try{
        	  service.save(entity);
