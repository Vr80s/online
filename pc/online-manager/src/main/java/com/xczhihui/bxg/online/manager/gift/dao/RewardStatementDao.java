...
public class RewardStatementDao extends HibernateDao<Course>{
	 ...
	 public Page<RewardStatementVo> findRewardStatementPage(RewardStatementVo rewardStatementVo, int pageNumber, int pageSize){
...
//			sql.append(" and DATE_FORMAT(ogs.create_time,'%Y-%m-%d') <=:stopTime");
		 ...
		 Page<RewardStatementVo> rewardStatementVos = this.findPageBySQL(sql.toString(), paramMap, RewardStatementVo.class, pageNumber, pageSize);
