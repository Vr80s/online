...
public class LecturerDao extends HibernateDao<Lecturer>{
	...
	CloudClassMenuDao MenuDao;
	 public Page<LecturerVo> findLecturerPage(LecturerVo lecturerVo, int pageNumber, int pageSize){
		 Map<String,Object> paramMap=new HashMap<String,Object>();
		 	StringBuilder sql =new StringBuilder("select * from oe_lecturer where 1=1 and is_delete=0 ");
			if(lecturerVo.getName() != null){
		 	...
		 	Page<LecturerVo> result=this.findPageBySQL(sql.toString(), paramMap, LecturerVo.class, pageNumber, pageSize);
	        ...
	        for(LecturerVo temp :result.getItems() ){
	        	...
	        	List<LecturerVo> res = this.findEntitiesByJdbc(LecturerVo.class, sqlIsUsed, paramMap);
