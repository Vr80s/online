...
import com.xczhihui.bxg.online.manager.operate.dao.MobileBannerDao;
...
@Service
public class MobileBannerServiceImpl extends OnlineBaseServiceImpl implements MobileBannerService {
	...
	public Page<MobileBannerVo> findMobileBannerPage(MobileBannerVo mobileBannerVo, Integer pageNumber, Integer pageSize) {
		Page<MobileBannerVo> page = mobileBannerDao.findMobileBannerPage(mobileBannerVo, pageNumber, pageSize);
		return page;
	}
	...
	public boolean updateStatus(MobileBannerVo mobileBannerVo) {
	    ...
	    sql =" UPDATE oe_course_mobile_banner " +
			...
			" WHERE " +
			"	id = ? ";
		dao.getNamedParameterJdbcTemplate().getJdbcOperations().update(sql, new Object[]{mobileBannerVo.getId()});
		return true;
	}
	...
	public void updateSortUp(String id) {
         ...
         Integer mobileBannerNextSort = Integer.valueOf(map.get("seq").toString());
