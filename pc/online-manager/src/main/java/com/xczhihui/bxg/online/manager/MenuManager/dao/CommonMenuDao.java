...
import com.xczhihui.bxg.online.manager.ask.dao.TagDao;
...
public class CommonMenuDao extends HibernateDao<Menu> {
    ...
    public Page<MenuVo> findCloudClassMenuPage(MenuVo menuVo, int pageNumber, int pageSize){
        ...
        StringBuilder sql=new StringBuilder("select om.id,om.name,om.remark,om.create_person,om.create_time,om.status,om.sort"
    ...
    public Integer getMaxYunSort(){
        ...
        Map<String,Object> result=this.getNamedParameterJdbcTemplate().queryForMap(sql,new HashMap<String,Object>());
        return Integer.parseInt(result.get("maxYunSort") != null ? String.valueOf(result.get("maxYunSort")) : "1");
    }
    ...
    public Integer getMaxBoSort(){
        ...
        Map<String,Object> result=this.getNamedParameterJdbcTemplate().queryForMap(sql,new HashMap<String,Object>());
        return Integer.parseInt(result.get("maxBoSort") != null ? String.valueOf(result.get("maxBoSort")) : "1");
    }
    
    public Integer getMinSort(){
    	String sql=" select ifnull(min(sort),0) as minSort from oe_menu where level=1 and is_delete=0  ";
    	Map<String,Object> result=this.getNamedParameterJdbcTemplate().queryForMap(sql,new HashMap<String,Object>());
    	return Integer.parseInt(result.get("minSort") != null ? String.valueOf(result.get("minSort")) : "1");
    }
    ...
    public Integer getMinYunSort(){
    	...
    	Map<String,Object> result=this.getNamedParameterJdbcTemplate().queryForMap(sql,new HashMap<String,Object>());
    	return Integer.parseInt(result.get("minYunSort") != null ? String.valueOf(result.get("minYunSort")) : "1");
    }
