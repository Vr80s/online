package com.xczhihui.bxg.online.manager.barrier.service.impl;

import com.xczhihui.bxg.common.util.bean.Page;
import com.xczhihui.bxg.online.common.base.service.impl.OnlineBaseServiceImpl;
import com.xczhihui.bxg.online.manager.barrier.dao.MarkExamPapersDao;
import com.xczhihui.bxg.online.manager.barrier.service.MarkExamPapersService;
import com.xczhihui.bxg.online.manager.barrier.vo.*;
 ...
 */
@Service
public class MarkExamPapersServiceImpl extends OnlineBaseServiceImpl implements MarkExamPapersService{
    ...
    @Override
    public Page<MarkGradeVo> findGradeList(MarkGradeVo gradeVo, Integer pageNumber, Integer pageSize) {
        Map<String,Object> paramMap= new HashMap<>();
        ...
        return  dao.findPageBySQL(sql.toString(),paramMap,MarkGradeVo.class, pageNumber, pageSize);
    }

    @Override
    public Page<MarkBarrierVo> findbarriers(Integer grade_id,Integer pageNumber, Integer pageSize) {
        Map<String,Object> paramMap= new HashMap<>();
        pageNumber = pageNumber == null ? 1 : pageNumber;
        pageSize = pageSize == null ? 20 : pageSize;
        StringBuilder sql=new StringBuilder() ;
        ...
        return  dao.findPageBySQL(sql.toString(),paramMap,MarkBarrierVo.class, pageNumber, pageSize);
    }

    @Override
    public Page<MarkRecordVo> findBarrierRecord(Integer barrier_status,String user_name,Integer grade_id,String barrier_id, Integer pageNumber, Integer pageSize) {
        Map<String,Object> paramMap= new HashMap<>();
        pageNumber = pageNumber == null ? 1 : pageNumber;
        pageSize = pageSize == null ? 20 : pageSize;
        StringBuilder sql=new StringBuilder() ;
        ...
        return  dao.findPageBySQL(sql.toString(),paramMap,MarkRecordVo.class, pageNumber, pageSize);
    }

    @Override
    public List<Map<String, Object>> getExamNum(String user_id, String barrier_id) {
        StringBuilder sql=new StringBuilder() ;
        sql.append("select \n");
        sql.append("obr.id,\n");
        ...
        List<Map<String, Object>> list = dao.getNamedParameterJdbcTemplate().getJdbcOperations().queryForList(sql.toString(),user_id,barrier_id);
    ...
    public Map<String,Object> getExamPaper(String record_id) {
        ...
        /** 组装试卷信息及试题 */
        List<ExamPaperVo> question0 = markExamPapersDao.getQuestionByType(record_id,0);//单选题
        List<ExamPaperVo> question1 = markExamPapersDao.getQuestionByType(record_id,1);//多选题
        List<ExamPaperVo> question2 = markExamPapersDao.getQuestionByType(record_id,2);//判断题

        PaperInfoVo paper0 = markExamPapersDao.getQuestionInfoByType(record_id,0);//单选题信息
        paper0.setExamPaper(question0);
        PaperInfoVo paper1 = markExamPapersDao.getQuestionInfoByType(record_id,1);//多选题信息
        paper1.setExamPaper(question1);
        PaperInfoVo paper2 = markExamPapersDao.getQuestionInfoByType(record_id,2);//判断题信息
