...
import com.xczhihui.bxg.online.manager.cloudClass.dao.TrackRecordDao;
import com.xczhihui.bxg.online.manager.cloudClass.service.ApplyService;
import com.xczhihui.bxg.online.manager.cloudClass.service.TrackRecordService;
...
public class TrackRecordServiceImpl extends OnlineBaseServiceImpl implements TrackRecordService {
	...
	public Page<TrackRecordVo> findPage(TrackRecordVo trackRecordVo, int pageNumber, int pageSize) {
		return trackRecordDao.findTrackRecordPage(trackRecordVo,pageNumber,pageSize);
	}
	...
	public TrackRecord findById(String id) {
		return trackRecordDao.findOneEntitiyByProperty(TrackRecord.class,"id",id);
	}
