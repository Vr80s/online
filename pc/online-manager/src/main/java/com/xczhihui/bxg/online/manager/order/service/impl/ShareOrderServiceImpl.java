...
import com.xczhihui.bxg.online.manager.order.dao.ShareOrderDao;
import com.xczhihui.bxg.online.manager.order.service.ShareOrderService;
import com.xczhihui.bxg.online.manager.order.vo.ShareOrderVo;

@Service
public class ShareOrderServiceImpl extends OnlineBaseServiceImpl implements ShareOrderService {
	...
	public Page<ShareOrderVo> findShareOrderPage(ShareOrderVo shareOrderVo, Integer pageNumber, Integer pageSize) {
		Page<ShareOrderVo> page = shareOrderDao.findShareOrderPage(shareOrderVo, pageNumber, pageSize);
		return page;
	}

	@Override
	public Page<ShareOrderVo> findShareOrderDetailPage(ShareOrderVo shareOrderVo, Integer pageNumber,
			Integer pageSize) {
		Page<ShareOrderVo> page = shareOrderDao.findShareOrderDetailPage(shareOrderVo, pageNumber, pageSize);
		return page;
	}
	...
	public List getOrderDetailList(ShareOrderVo shareOrderVo) {
		...
		List list = shareOrderDao.getNamedParameterJdbcTemplate().queryForList(sql, paramMap);
		return list;
	}
