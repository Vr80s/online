package com.xczhihui.bxg.online.manager.message.service;
...
public interface MessageService {
	 ...
	 * @return 分页对象
	 */
	public Page<MessageVo> findPageMessages(String vNameOrCreater, int pageNumber,
										int pageSize) throws InvocationTargetException, IllegalAccessException;
	 ...
	 * @return 分页对象
	 */
	public Page<MessageVo> findPageMessagesByUser(UserVo userVo,String vNameOrCreater, int pageNumber,
											int pageSize);
