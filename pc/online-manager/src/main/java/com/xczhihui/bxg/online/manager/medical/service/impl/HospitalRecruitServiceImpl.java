...
import com.xczhihui.bxg.online.manager.medical.dao.HospitalRecruitDao;
import com.xczhihui.bxg.online.manager.medical.service.HospitalRecruitService;
...
public class HospitalRecruitServiceImpl implements HospitalRecruitService {
    ...
    public Page<MedicalHospitalRecruit> findMedicalHospitalRecruitPage(MedicalHospitalRecruit searchVo, int pageNumber, int pageSize) {
        return hospitalRecruitDao.findMedicalHospitalRecruitPage(searchVo, pageNumber, pageSize);
    }

    @Override
    public void updateMedicalHospitalRecruit(MedicalHospitalRecruit medicalHospitalRecruit) {
        MedicalHospitalRecruit old = findMedicalHospitalRecruitById(medicalHospitalRecruit.getId());
    ...
    public void updateRecruitStatus(String id) {
        ...
        MedicalHospitalRecruit medicalHospitalRecruit = hospitalRecruitDao.findByHQLOne(hql, new Object[]{id});
    ...
    public void deleteByIds(String[] ids) {
        for (String id : ids) {
            ...
            MedicalHospitalRecruit medicalHospitalRecruit = hospitalRecruitDao.findByHQLOne(hqlPre, new Object[]{id});
    ...
    public void updateSortDown(String id) {
        ...
        MedicalHospitalRecruit medicalHospitalRecruit = hospitalRecruitDao.findByHQLOne(hqlPre, new Object[]{id});
        Integer currentSort = medicalHospitalRecruit.getSort() == null ? 0 : medicalHospitalRecruit.getSort();

        String hqlNext = "from MedicalHospitalRecruit where sort < (select sort from MedicalHospitalRecruit where id= ? )" +
                "  and deleted=0 and hospital_id = '" + medicalHospitalRecruit.getHospitalId() + "' order by sort desc";
        MedicalHospitalRecruit medicalHospitalRecruitDown = hospitalRecruitDao.findByHQLOne(hqlNext, new Object[]{id});
    ...
    public void updateSortUp(String id) {
        ...
        MedicalHospitalRecruit medicalHospitalRecruitUp = hospitalRecruitDao.findByHQLOne(hqlNext, new Object[]{id});
    ...
    public MedicalHospitalRecruit findMedicalHospitalRecruitById(String id) {
        return hospitalRecruitDao.findOneEntitiyByProperty(MedicalHospitalRecruit.class, "id", id);
    }
    ...
    public void addMedicalHospitalRecruit(MedicalHospitalRecruit medicalHospitalRecruit) {
        ...
        int sort = hospitalRecruitDao.queryForInt(sql, medicalHospitalRecruit.getHospitalId());
