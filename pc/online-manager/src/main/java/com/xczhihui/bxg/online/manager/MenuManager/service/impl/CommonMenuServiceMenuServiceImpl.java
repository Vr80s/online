 ...
 */
@Service
public class CommonMenuServiceMenuServiceImpl extends OnlineBaseServiceImpl implements CommonMenuService {
    ...
    public Page<MenuVo> findMenuPage(MenuVo menuVo, Integer pageNumber, Integer pageSize)  {
        Page<MenuVo> page = commonMenuDao.findCloudClassMenuPage(menuVo, pageNumber, pageSize);
        return page;
    }
    ...
    public List<MenuVo> list() {
        ...
        List<MenuVo> voList=commonMenuDao.findEntitiesByJdbc(MenuVo.class, sql, params);
        return voList;
    }
...
//        commonMenuDao.deletes(ids);
    ...
    public void updateChildrenMenuDirectionUp(String pid, String id, Integer level) {
        ...
        Menu preMenu=commonMenuDao.updateDirectionUp(parentMenu.getNumber(),Integer.parseInt(id),level);
        Menu me=commonMenuDao.findById(Integer.parseInt(id));
        Integer meSort=me.getSort();
        me.setSort(preMenu.getSort());
        preMenu.setSort(meSort);
    ...
    public void updateChildrenMenuDirectionDown(String pid, String id, Integer level) {
        Menu parentMenu=commonMenuDao.findById(Integer.parseInt(pid));
        Menu downMenu=commonMenuDao.updateDirectionDown(parentMenu.getNumber(),Integer.parseInt(id),level);
        Menu me=commonMenuDao.findById(Integer.parseInt(id));
        Integer meSort=me.getSort();
        me.setSort(downMenu.getSort());
        downMenu.setSort(meSort);
