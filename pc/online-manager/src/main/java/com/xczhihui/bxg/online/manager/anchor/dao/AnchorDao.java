...
public class AnchorDao extends HibernateDao<CourseAnchor>{
	...
	private void setEnchashmentCount(AnchorIncomeVO courseAnchorIncome, String userId) {
	 	String sql = "SELECT \n" +
	...
	private void setEnchashmentTotal(AnchorIncomeVO courseAnchorIncome, String userId) {
		String sql = "SELECT \n" +
