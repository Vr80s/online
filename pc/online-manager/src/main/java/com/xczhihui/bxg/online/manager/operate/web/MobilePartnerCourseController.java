...
public class MobilePartnerCourseController {
    ...
    public ResponseObject courseInfo(){
        MobilePartnerCourseVo mobilePartnerCourse= mobilePartnerCourseService.findCourseInfoByCourseId();
    ...
    @ResponseBody
    public ResponseObject saveOrUpdate(MobilePartnerCourseVo mobilePartnerCourseVo){
