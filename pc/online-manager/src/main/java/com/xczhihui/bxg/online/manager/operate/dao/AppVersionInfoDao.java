...
public class AppVersionInfoDao extends SimpleHibernateDao {
	...
	public Page<AppVersionInfo> findAppVersionInfoPage(
		...
		Map<String,Object> paramMap=new HashMap<String,Object>();
		   StringBuilder sql=new StringBuilder("SELECT avi.`id`,avi.`filename`,avi.`describe`,avi.`down_url`,avi.status,avi.`version`,u.`name` createPerson,avi.is_must_update mustUpdate"
