...
public class VideoResDao extends HibernateDao<VideoResVo>{
	...
	public Page<VideoResVo> findCloudVideoResPage(VideoResVo searchVo, int currentPage,int pageSize) {
		// TODO Auto-generated method stub
		Map<String,Object> paramMap=new HashMap<String,Object>();
	 	StringBuilder sql =new StringBuilder("select v.* from oe_chapter c,oe_video v where v.course_id = "+searchVo.getCourseId()+ " and c.course_id="+searchVo.getCourseId()+" and c.is_delete = 0 and v.is_delete = 0 and c.id=v.chapter_id" );
	 	...
	 	Page<VideoResVo> ms = this.findPageBySQL(sql.toString(), paramMap, VideoResVo.class, currentPage, pageSize);
	 	return ms;
	}
