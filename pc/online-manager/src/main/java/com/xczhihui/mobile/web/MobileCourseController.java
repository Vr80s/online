...
public class MobileCourseController extends AbstractController{
	...
	public TableVo courses(TableVo tableVo) {
		...
		if (searchCourse != null) {
			searchVo.setIsCourseDetails(Integer.parseInt(searchCourse.getPropertyValue1().toString()));
		}
          Page<CourseVo> page = mobileCourseService.findCoursePage(searchVo, currentPage, pageSize);
	...
	@ResponseBody
	 public ResponseObject getCourseDetail(String courseId){
    	return ResponseObject.newSuccessResponseObject(mobileCourseService.getCourseDetail(courseId));
    }
    /**
	 * 获得模板内容
	 * @param type
	...
	@ResponseBody
	 public ResponseObject updateCourseDetail(String courseId, String smallImgPath, String courseDetail,
				String courseOutline, String commonProblem){
		mobileCourseService.updateCourseDetail(courseId, smallImgPath, null, courseDetail, courseOutline, commonProblem);
        return ResponseObject.newSuccessResponseObject("修改成功！");
    }
	
	@RequestMapping(value = "addPreview", method = RequestMethod.POST)
	@ResponseBody
	 public ResponseObject addPreview(String courseId, String smallImgPath, String courseDetail,
				String courseOutline, String commonProblem){
		mobileCourseService.addPreview(courseId, smallImgPath, null, courseDetail, courseOutline, commonProblem);
