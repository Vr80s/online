...
import com.xczhihui.cloudClass.dao.StudentStoryDao;
...
import com.xczhihui.cloudClass.service.StudentStoryService;
import com.xczhihui.support.shiro.ManagerUserUtil;

@Service
public class StudentStoryServiceImpl extends OnlineBaseServiceImpl implements
		StudentStoryService {
	...
	public Page<StudentStory> findStudentStoryPage(StudentStory studentStory,
		...
		return studentStoryDao.findCloudClassCoursePage(studentStory,
				pageNumber, pageSize);
	}
	...
	public void deletes(String[] ids) {
		for (String id : ids) {
			...
			StudentStory studentStory = dao.findByHQLOne(hqlPre,
					new Object[] { id });
	...
	public void updateStudentStory(StudentStory studentStory) {
		StudentStory studentStoryOld = dao.get(studentStory.getId(),
				StudentStory.class);
