...
import com.xczhihui.cloudClass.dao.CourseRecommendDao;
import com.xczhihui.cloudClass.service.CourseRecommendService;
import com.xczhihui.cloudClass.vo.CourseRecommendVo;
import com.xczhihui.cloudClass.vo.CourseVo;

@Service
public class CourseRecommendServiceImpl extends OnlineBaseServiceImpl implements CourseRecommendService {
	...
	public Page<CourseVo> findCourseRecommendPage(CourseRecommendVo courseRecommendVo, Integer pageNumber, Integer pageSize) {
		Page<CourseVo> page = courseRecommendDao.findCourseRecommendPage(courseRecommendVo, pageNumber, pageSize);
		return page;
	}
	...
	public void updateSortUp(Integer id) {
		// TODO Auto-generated method stub
		 ...
		 CourseRecommend courseRecommendPre= dao.findByHQLOne(hqlPre,new Object[] {id});
         ...
         CourseRecommend courseRecommendNext = dao.findByHQLOne(hqlNext,new Object[] {id,courseRecommendPre.getShowCourseId()});
	...
	public void deletes(String[] ids) {
		...
		for(String id:ids){
			String hqlPre="from CourseRecommend where isDelete=0 and id = ?";
			CourseRecommend courseRecommend= dao.findByHQLOne(hqlPre,new Object[] {Integer.valueOf(id)});
	...
	public void addCourseRecommend(String showCourseId, String[] recCourseHids,String createPerson) {
		...
		List<CourseRecommend>  list= dao.findByHQL(hql, new Object[]{Integer.parseInt(showCourseId)});
