...
public class CourseRecommendDao extends SimpleHibernateDao {
	...
	public Page<CourseVo> findCourseRecommendPage(
			CourseRecommendVo courseRecommendVo, int pageNumber, int pageSize) {
		// Map<String,Object> paramMap=new HashMap<String,Object>();
		// StringBuilder sql=new StringBuilder("");
		//
		// Page<CourseRecommendVo> ms = this.findPageBySQL(sql.toString(),
		// paramMap, CourseRecommendVo.class, pageNumber, pageSize);
		// return ms;

		Map<String, Object> paramMap = new HashMap<String, Object>();
		StringBuilder sql = new StringBuilder(
				"SELECT ocr.id ,oc.id showCourseId,oc.grade_name as courseName, oc.class_template as classTemplate, om.name as xMenuName,st.name as scoreTypeName,"
