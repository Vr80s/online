...
public class StudentGradeController {
	...
	public ResponseObject saveStudentRecord(HttpServletRequest request,
			TrackRecordVo vo) throws InvocationTargetException,
	...
	public ResponseObject updateStudentRecord(HttpServletRequest request,
			TrackRecordVo vo) throws InvocationTargetException,
			IllegalAccessException {
	...
	public ResponseObject deleteStudentRecord(HttpServletRequest request,
			@PathVariable String id) throws InvocationTargetException,
			IllegalAccessException {
	...
	public TableVo findTrackRecordList(TableVo tableVo) {
		...
		if (gradeId != null) {
			trackRecordVo.setGradeId(Integer.parseInt(gradeId
					.getPropertyValue1().toString()));
		}
		Page<TrackRecordVo> page = trackRecordService.findPage(trackRecordVo,
	...
	public TableVo findStudentList(TableVo tableVo) {
		...
		// }
		Page<ApplyVo> page = applyService.findPage(searchVo, currentPage,
				pageSize);
		int total = page.getTotalCount();
		tableVo.setAaData(page.getItems());
		tableVo.setiTotalDisplayRecords(total);
