...
public class PublicCourseController {
	...
	public TableVo courses(TableVo tableVo) {
		...
		if (lecturerName != null) {
			searchVo.setLecturerName(lecturerName.getPropertyValue1()
					.toString());
		}
		...
		Page<CourseVo> coursePage = publicCourseService.findCoursePage(
	...
	public TableVo coursesRec(TableVo tableVo) {
		...
		if (endTime != null) {
			searchVo.setEndTime(DateUtil.parseDate(endTime.getPropertyValue1()
					.toString(), "yyyy-MM-dd"));
		}
	...
	@ResponseBody
	public ResponseObject reCreateWebinar(Integer courseId)
	...
	@ResponseBody
	public ResponseObject changeCallback(ChangeCallbackVo changeCallbackVo)
			throws IllegalAccessException, InvocationTargetException {
		ResponseObject responseObj = new ResponseObject();
