...
public class PPTResServiceImpl implements PPTResService {
	...
	public Page<Files> findCasePage(Files searchVo, int currentPage,
		...
		// TODO Auto-generated method stub
		return pptResDao.findCaseResPage(searchVo, currentPage, pageSize,
				domain);
	}
	...
	public void updatePPT(Files ppt, String isuploadFile) {
		// TODO Auto-generated method stub
		Files entity = pptResDao.findOneEntitiyByProperty(Files.class, "id",
				ppt.getId());
		if ("1".equals(isuploadFile)) {
			entity.setFileUrl(ppt.getFileUrl());
			entity.setSuffix(ppt.getFileUrl().substring(
					ppt.getFileUrl().lastIndexOf(".")));
		}
	...
	public void deletePPTById(String id) {
		// TODO Auto-generated method stub
		Files entity = pptResDao
				.findOneEntitiyByProperty(Files.class, "id", id);
	...
	public void updateStatus(String id) {
		...
		String sql = "select * from oe_files where course_id = "
				+ entity.getCourseId() + " and chapter_id = '"
				+ entity.getChapterId()
				+ "' and is_delete=0 and status =1 and type = "
				+ entity.getType() + " and id != '" + entity.getId() + "'";
		List<Files> temps = pptResDao.findEntitiesByJdbc(Files.class, sql,
	...
	public void deletes(String[] ids) {
		// TODO Auto-generated method stub
		for (String id : ids) {
			Files entity = pptResDao.findOneEntitiyByProperty(Files.class,
					"id", id);
			entity.setDelete(true);
			pptResDao.update(entity);
	...
	public String mdFile2Html(String id) throws Exception {
		...
		String url = pptResDao.getNamedParameterJdbcTemplate()
				.getJdbcOperations().queryForObject(sql, String.class, id);
