 ...
 */
@Service
public class LecturerServiceImpl extends OnlineBaseServiceImpl implements
		LecturerService {
	...
	public Page<LecturerVo> findLecturerPage(LecturerVo searchVo,
		...
		Page<LecturerVo> page = lecturerDao.findLecturerPage(searchVo,
				pageNumber, pageSize);
		for (LecturerVo lecturer : page.getItems()) {
			String str = systemVariateService.getNameByValue("role_type",
					lecturer.getRoleType());
