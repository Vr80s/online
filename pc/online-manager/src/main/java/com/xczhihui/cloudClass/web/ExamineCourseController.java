...
public class ExamineCourseController {
	...
	public TableVo courses(TableVo tableVo) {
		...
		Page<LiveExamineInfoVo> page = examineCourseService.findCoursePage(
	...
	@ResponseBody
	public ResponseObject cxBoHui(String id) throws InvocationTargetException,
			IllegalAccessException {
		ResponseObject responseObject = new ResponseObject();
		// if(ids!=null) {
		// String[] _ids = ids.split(",");
	...
	@ResponseBody
	public ResponseObject getApplysByExamId(String id)
			throws InvocationTargetException, IllegalAccessException {

		return ResponseObject.newSuccessResponseObject(examineCourseService
				.getApplysByExamId(id));
	}
