...
import com.xczhihui.cloudClass.dao.NotesCommentDao;
import com.xczhihui.cloudClass.service.NotesCommentService;

@Service
public class NotesCommentServiceImpl extends OnlineBaseServiceImpl implements
		NotesCommentService {
	...
	public Page<NotesCommentVo> findNotesCommentPage(
		...
		Page<NotesCommentVo> page = notesCommentDao.findNotesCommentPage(
				notesCommentVo, pageNumber, pageSize);
		return page;
	}
	...
	public void deletes(String[] ids) {
		...
		for (String id : ids) {
			...
			NotesComment notesComment = dao.findByHQLOne(hqlPre,
					new Object[] { id });
			...
			Notes notes = dao.findByHQLOne(hqlPre,
					new Object[] { notesComment.getNotesId() });
