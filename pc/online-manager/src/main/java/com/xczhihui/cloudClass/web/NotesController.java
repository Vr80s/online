...
public class NotesController {
	...
	public TableVo findNotesList(TableVo tableVo) {
		...
		if (courseIdGroup != null) {
			searchVo.setCourseId(Integer.parseInt(courseIdGroup
					.getPropertyValue1().toString()));
		}
		...
		Page<NotesVo> page = notesService.findNotesPage(searchVo, currentPage,
				pageSize);
	...
	public TableVo findCourseList(TableVo tableVo) {
		...
		Page<CourseVo> page = notesService.findCoursePage(searchVo,
	...
	public ModelAndView notesDetail(NotesVo notesVo, HttpServletRequest request) {
		...
		request.setAttribute("gradeList", gradeService
				.getGradeByCourseId(notesVo.getCourseId().toString()));
		return mav;
	}
