...
public class ScoreTypeController {
	...
	public TableVo list(TableVo tableVo) {
		...
		if (time_startGroup != null) {
			searchVo.setTime_start(DateUtil.parseDate(time_startGroup
					.getPropertyValue1().toString(), "yyyy-MM-dd"));
		}
		if (time_startGroup != null) {
			searchVo.setTime_end(DateUtil.parseDate(time_endGroup
					.getPropertyValue1().toString(), "yyyy-MM-dd"));
		}
		if (nameGroup != null) {
			searchVo.setName(nameGroup.getPropertyValue1().toString());
		}
		Page<ScoreTypeVo> page = service.findMenuPage(searchVo, currentPage,
				pageSize);
	...
	@ResponseBody
	public ResponseObject add(ScoreTypeVo scoreTypeVo)
	...
	@ResponseBody
	public ResponseObject update(ScoreTypeVo scoreTypeVo)
			throws InvocationTargetException, IllegalAccessException {
