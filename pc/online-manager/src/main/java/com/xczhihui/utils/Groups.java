...
import com.xczhihui.utils.PropertyFilter.MatchType;

/**
 * 一个Groups对应一条复杂语句，不再用多个Groups来完成 方便操作 Groups 与group 类 初定 验证之类的还未完善
 * 
 */
public class Groups {
	...
	/**
	 * 别名解析 查询方式　 为true表示需要解析;为 false 不需要解析
	 * 
	 */
	...
	/**
	 * 排序方式 true 表示　升序 false 表示降序 默认为降序
	 */
