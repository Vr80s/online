...
public class Group {
	...
	public Group(String propertyName, Object propertyValue, PropertyFilter.MatchType matchType) {
		this.propertyName = propertyName;
		this.propertyValue1 = propertyValue;
		this.matchType = matchType;
	}

	public Group(String propertyName, PropertyFilter.MatchType matchType, PropertyFilter.MatchType relation) {
		this.propertyName = propertyName;
		this.matchType = matchType;
	...
	public Group(String propertyName, Object propertyValue,
                 PropertyFilter.MatchType matchType, PropertyFilter.MatchType relation) {
		this.propertyName = propertyName;
		this.propertyValue1 = propertyValue;
		this.matchType = matchType;
		this.relation = relation;
	...
	public Group(String propertyName, Object propertyValue1,
                 Object propertyValue2, PropertyFilter.MatchType matchType, PropertyFilter.MatchType relation) {
		this.propertyName = propertyName;
