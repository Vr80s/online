 ...
 */
@Service
public class CommonServiceImpl extends OnlineBaseServiceImpl implements
		CommonService {
	...
	public List<KeyValVo> getAllOccupationList() {
		return commonDao
				.getCommonDataList(CommonGroupEnum.OCCUPATION.getName());
	}
	...
	public Map<String, Object> updateImportExcel(InputStream inputStream,
		...
		try {
			listob = excelUtil
					.getBankListByExcel(inputStream, originalFilename);
		} catch (Exception e) {
			e.printStackTrace();
		}
