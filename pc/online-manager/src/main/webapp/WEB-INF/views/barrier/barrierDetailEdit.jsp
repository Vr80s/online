		 ...
		 <fieldset>
	      ...
	      <div class="form-group"  style="margin-top: 10px;">
	         ...
	         <div class="col-xs-3" style="padding-top: 7px;">
	         	<span id="selectionKpoints" style="width:100%" class="text-overflow">${param.kpointName}</span>
	            <input class="form-control" name="oldKpointIds" id="oldKpointIds" type="hidden" value=""/>
	   ...
	   <fieldset>
	       ...
	       <div class="form-group">
	          ...
	          <div class="col-sm-10" style="padding-top: 7px;font-size: 18px">
					...
					<input class="form-control  {equal0:true,equalTotalScore:true}" type="hidden" name="unDistributionScore_hid" id="unDistributionScore_hid" value="0">
	          </div>
	       </div>
	       <div class="form-group" style="margin-top: 10px;">
...
<script type="text/javascript" src="${base}/js/barrier/barrierDetailEdit.js?v=ipandatcm_1.3"></script>
