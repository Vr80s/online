...
<script type="text/javascript" src="/js/headline/columnList.js?v=ipandatcm_1.3"></script>
                ...
                <tr>
                    <td>
                        <div class="profile-info-value searchTr">
                            <input type="text" placeholder="关键词" class="propertyValue1" id="search_title"
                                   style="width: 150px;">
                    ...
                    <td>
                        <div class="profile-info-value searchTr">
                            <input type="text" class="datetime-picker propertyValue1" id="stopTime" name="stopTime"
                                   placeholder="结束日期" style="width:130px"/>
