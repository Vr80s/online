			                ...
			                <tr>
			                    <td>
			                        <div class="profile-info-value searchTr">
			                            <input type="text" placeholder = "医馆名" class="propertyValue1" id="search_hospitalName" style="width: 150px;">
			                            <input type="hidden" value="search_hospitalName" class="propertyName"/>
			                        </div>
			                    </td>
			                    <td>
			                       <div class="profile-info-value searchTr">
...
<script type="text/javascript" src="${base}/js/medical/hospitalApply.js?v=ipandatcm_1.3"></script>