...
<ul class="nav nav-tabs" role="tablist">
  ...
  <li role="presentation" class="active"><a href="#profile" role="tab" data-toggle="tab">医师详情</a></li>
		...
		<div id="detailDiv">
			<form class="form-horizontal" id="courseDetailForm" method="post" action="">
				...
				<div class="form-group" style="margin-top:18px;">
					<label class="col-sm-1 control-label no-padding-right"><font color="red">*</font>真实头像:</label>
					...
					<!-- 设置多个展示图 -->
                <div class="form-group" style="margin-top:18px;">
					<label class="col-sm-1 control-label no-padding-right"><font color="red">*</font>职称证明:</label>
					<div class="col-sm-3" style="width: 285px; height: 140px;">
                    <div class="clearfix">
                    ...
                    <!-- 设置多个展示图 -->
                    <div class="form-group" style="margin-top:18px;">
                        <label class="col-sm-1 control-label no-padding-right"><font color="red">*</font>身份证正面:</label>
                    <div class="col-sm-3" style="width: 285px; height: 140px;">
                    <div class="clearfix">
                    ...
                    <!-- 设置多个展示图 -->
                    <div class="form-group" style="margin-top:18px;">
                        <label class="col-sm-1 control-label no-padding-right"><font color="red">*</font>医师资格证:</label>
                    <div class="col-sm-3" style="width: 285px; height: 140px;">
						<div class="clearfix">
					...
					<!-- 设置多个展示图 -->
					<div class="form-group" style="margin-top:18px;">
					<label class="col-sm-1 control-label no-padding-right"><font color="red">*</font>职业医师证:</label>
					<div class="col-sm-3" style="width: 285px; height: 140px;">
						<div class="clearfix">
