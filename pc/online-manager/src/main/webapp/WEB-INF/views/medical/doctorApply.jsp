	...
	<ul class="nav nav-tab vertical-tab" role="tablist" id="vtab">
		<li role="presentation" class="active">
			<a href="#home" aria-controls="home" class="zykgl_bx" role="tab"
			   data-toggle="tab" style="padding-left: 0px;padding-right: 0px;">医师入驻</a>
		</li>
	</ul>
...
<div id="addCourseDialog" class="hide">
	<form id="addCourse-form" class="form-horizontal"  method="post" action="" style="margin-top: 15px;">
		...
		<div class="form-group"  style="margin-top: 18px;">
			...
			<div class="col-sm-6" >
				<input type="text" id="postCode" name="postCode" maxlength="15" class="col-xs-10 col-sm-12 {number:true,digits:true,minlength:5}">
			</div>
		</div>
		<div class="form-group"  style="margin-top: 18px;" >
 ...
 　　　　		　　</select>
		...
		<div class="form-group" id="add-currentPrice"  style="margin-top: 18px;" >
			 <label class="col-sm-3 control-label no-padding-right" for="detailedAddress"><font color="red">*</font>详细地址: </label>
			 <div class="col-sm-6">
			 	<input type="text" name="detailedAddress" value="" id="address"  class="col-xs-10 col-sm-12 {required:true}">
             </div>
		</div>
...
<div id="showCourseDialog" class="hide">
	<form id="addCourse-form1"  class="form-horizontal" method="post" action="">
		...
		<div class="form-group">
			 <label class="col-sm-4 control-label no-padding-right" for="name"><font color="red">*</font><b>医馆名称:</b> </label>
			 <div class="col-sm-6">
		...
		<div class="form-group">
			 <label class="col-sm-4 control-label no-padding-right" for="detailedAddress"><font color="red">*</font><b>详细地址:</b> </label>
			 <div class="col-sm-6">
...
<div id="EditCourseDialog" class="hide">
	...
	<input type="hidden" id="editHospital_id"  name="id" class="col-xs-10 col-sm-8 {required:true}">
		...
		<div class="form-group"  style="margin-top: 18px;" >
			<label class="col-sm-3 control-label no-padding-right" for="postCode">邮编: </label>
			<div class="col-sm-6" >
				<input type="text" id="edit_postCode" name="postCode" maxlength="15" class="col-xs-10 col-sm-12 {number:true,digits:true,minlength:5}">
			</div>
		</div>
		<div class="form-group"  style="margin-top: 18px;" >
			<label class="col-sm-3 control-label no-padding-right" for="email">email: </label>
		...
		<div class="form-group" style="margin-top: 18px;" >
			<label class="col-sm-3 control-label no-padding-right" for="detailedAddress"><font color="red">*</font>详细地址: </label>
			<div class="col-sm-6">
				<input type="text" name="detailedAddress" value="" id="edit_address"  class="col-xs-10 col-sm-12 {required:true}">
			</div>
		</div>
...
<div id="updateRecImgDialog" class="hide">
	<form id="updateRecImg-form" class="form-horizontal"  method="post" action="" style="margin-top: 15px;">
	    ...
	    <div class="space-4"></div>
		<div class="form-group"  style="margin-top: 18px;" >
			 <label class="col-sm-3 control-label no-padding-right" for="imgPath"><font color="red">*</font>医馆图片: </label>
...
<script type="text/javascript" src="${base}/js/medical/doctorApply.js?v=ipandatcm_1.3"></script>