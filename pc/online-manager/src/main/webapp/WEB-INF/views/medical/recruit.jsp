...
<div id="addCourseDialog" class="hide">
	<form id="addCourse-form" class="form-horizontal"  method="post" action="" style="margin-top: 15px;">
		<div class="form-group"  style="margin-top: 18px;" >
			<label class="col-sm-3 control-label no-padding-right" for="position"><font color="red">*</font>招聘职位: </label>
			<div class="col-sm-6">
				<input type="text" name="position"  id="position" class="col-xs-10 col-sm-12 {required:true,minlength:2,maxlength:30}">
		...
		<div class="form-group"  style="margin-top: 18px;">
			<label class="col-sm-3 control-label no-padding-right" for="postDuties"><font color="red">*</font>岗位职责: </label>
			<div class="col-sm-6">
...
<div id="showCourseDialog" class="hide">
	<form id="addCourse-form1"  class="form-horizontal" method="post" action="">
		...
		<div class="form-group">
			...
			<div class="col-sm-6">
				<p id="show_years" class="paddingtop7px padding7" style="word-break:break-all;word-wrap:break-word;width:250px"></p>
			</div>
		</div>
		<div class="form-group">
			<label class="col-sm-4 control-label no-padding-right" ><b>岗位职责:</b> </label>
			<div class="col-sm-6">
				<p id="show_postDuties" class="paddingtop7px padding7" style="word-break:break-all;word-wrap:break-word;width:250px"></p>
			</div>
		</div>
		<div class="form-group">
			<label class="col-sm-4 control-label no-padding-right" ><b>职位要求:</b> </label>
			<div class="col-sm-6">
				<p id="show_jobRequirements" class="paddingtop7px padding7" style="word-break:break-all;word-wrap:break-word;width:250px"></p>
			</div>
		</div>
	</form>
</div>
...
<script type="text/javascript" src="${base}/js/medical/recruit.js?v=ipandatcm_1.3"></script>