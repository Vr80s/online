            ...
            <table frame=void >
                <tr>
					...
					<td style="display: none">
						<div class="profile-info-value searchTr">
							<input type="text" value="6" id="search_type" class="propertyValue1" maxlength="30"/>
	...
	<form id="addBanner2-form" class="form-horizontal"  method="post" action="" style="margin-top: 15px;">
		<div class="form-group"  style="margin-top: 18px;" >
			 ...
			 <div class="col-sm-6">
			 		...
			 		<input type="hidden" name="type" value="6"  maxlength="50">
             </div>
		</div>
...
<script type="text/javascript" src="${base}/js/operate/banner2.js?v=1.7"></script>