    ...
    <div class="main-container" id="main-container">
		...
		<div class="contextMenu" id="myMenu1" style="display:none">
			<ul>
				...
				<li id="copyTree"><i class="ace-icon glyphicon glyphicon-copyright-mark bigger-120 green"></i> <span id="mCopy"></span></li>
				<li id="updateTree"><i class="ace-icon fa fa-pencil-square-o bigger-120 blue"></i> <span id="mEdit"></span></li>
