			                ...
			                <tr>
			                    <td>
			                        <div class="profile-info-value searchTr">
			                            <input type="text" placeholder = "资源名称" class="propertyValue1" id="search_title" style="width: 150px;">
			                            <input type="hidden" value="search_title" class="propertyName"/>
			                        </div>
			                    </td>
								<td>
									<div class="profile-info-value searchTr">
										<input type="text" placeholder = "上传人昵称" class="propertyValue1" id="search_name" style="width: 150px;">
								...
								<td>
									<div class="profile-info-value searchTr">
										<select name="search_isDeleted" id="search_isDeleted" value="" class="propertyValue1" >
											<option value="">全部</option>
											<option value="1">已删除</option>
											<option value="0">未删除</option>
										</select>
										<input type="hidden" value="search_isDeleted" class="propertyName"/>
									</div>
								</td>
								<%--<td>--%>
									<%--<div class="profile-info-value searchTr">--%>
...
<script type="text/javascript" src="${base}/js/cloudClass/courseApplyResource.js?v=ipandatcm_1.3"></script>