...
<script type="text/javascript" src="/js/cloudClass/scoreType1.js?ver=1.2"></script>
<%-- <script type="text/javascript" src="/js/cloudClass/scoreTypeSxxy.js?ver=1.2"></script> --%>
