  ...
  <form  method="post" class="form-horizontal" role="form" id="add-form" style="margin-top: 15px;">
    ...
    <div class="form-group">
      ...
      <div class="col-xs-12 col-sm-9">
        <input type="text" name="name" style="margin-right: 15px;"  maxlength="10" class="col-xs-10 col-sm-8 {required:true,minlength:1}">
...
<div id="updateDialog" class="hide">
    <form action="user/role/add" method="post" class="form-horizontal" role="form" id="update-form" style="margin-top: 15px;">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <input type="text" id="update_name" name="name"  style="margin-right: 15px;"  maxlength="3" class="col-xs-10 col-sm-8 {required:true,minlength:2}">
            </div>
        </div>
...
<script type="text/javascript" src="${base}/js/cloudClass/scoreType1.js?ver=1.2"></script>
<%-- <script type="text/javascript" src="${base}/js/cloudClass/scoreTypeSxxy.js?ver=1.2"></script> --%>
