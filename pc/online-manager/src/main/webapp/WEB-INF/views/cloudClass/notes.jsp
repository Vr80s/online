...
<div class="mainrighttab tabresourse bordernone">
	<p class="col-xs-4" style="padding: 0;">
		<button class="btn btn-sm btn-success bj_num" title="笔记条数从高到低排列" onclick="search(1)">
			笔记条数↓
		</button>
	</p>
...
<script type="text/javascript" src="${base}/js/cloudClass/notes.js?v=ipandatcm_1.3"></script>
