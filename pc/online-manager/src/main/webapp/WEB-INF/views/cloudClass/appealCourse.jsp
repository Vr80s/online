...
<div class="page-header">
	当前位置：直播申请管理<small> <i class="ace-icon fa fa-angle-double-right"></i>
	</small> <span> 申诉审核 </span>
</div>
			            ...
			            <table frame=void >
			                <tr>
			                   ...
			                   <td>
			                    ...
			                    <td>
			                       <div class="profile-info-value searchTr">
			                            <select name="search_ssIsdelete" id="search_ssIsdelete" value="" class="propertyValue1" >
						               		    <option value="">是否有效</option>
						                        <option value="0">有效</option>
						                        <option value="1">无效</option>
						               </select>
			                            <input type="hidden" value="search_ssIsdelete" class="propertyName"/>
			                        </div>
			                    </td>
...
<script type="text/javascript" src="/js/cloudClass/appealCourse.js?v=ipandatcm_1.3"></script>