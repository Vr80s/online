...
<div id="updateBanner2Dialog" class="hide">
	<form id="updateBanner2-form" class="form-horizontal"  method="post" action="" style="margin-top: 15px;">
		...
		<div class="form-group"  style="margin-top: 18px;" >
			<label class="col-sm-3 control-label no-padding-right" ><font color="red">*</font>链接地址: </label>
			<div class="col-sm-6">
				<input type="text" name="linkCondition"  id="update_linkCondition" class="col-xs-10 col-sm-12 {required:true,maxlength:225}">
			</div>
		</div>
...
<script type="text/javascript" src="${base}/js/cloudClass/projectType.js?v=ipandatcm_1.3"></script>