...
<script type="text/javascript" src="js/boxueshe/articleEdit.js"></script>
	 ...
	 <input type="hidden" name="id" value="${article.id}" id="id" >
		...
		<div class="form-group " style="margin-top:18px;margin-bottom:60px">
			...
			<div class="col-lg-10 " style="height:250px">
				<div class="clearfix">
					<div class="wysiwyg-editor" style="max-height:300px;height: 400px;"id="article_content">${article.content}</div><br>
