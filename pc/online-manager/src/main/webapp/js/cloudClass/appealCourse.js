...
$(function(){
    ...
    { "title": "主播", "class":"center","width":"5%","sortable":false,"data": 'lecturerName',"mRender":function (data, display, row) {
		return "<span name='lecturerNameList'>"+data+"</span>";
    } },
    
    { "title": "课程名", "class":"center","width":"8%","sortable":false,"data": 'title',"mRender":function (data, display, row) {
    	return "<span name='lecturerNameList'>"+data+"</span>";
    } },
  
    
    
    { "title": "状态", "class":"center","width":"5%","sortable":false,"data": 'examineStatus',"mRender":function (data, display, row) {
    ...
    { "title": "驳回原因", "class":"center","width":"8%","sortable":false,"data": 'againstReason',"mRender":function (data, display, row) {
		
    	if(data==null){
    		return "暂无";
		}
    	return "<span name='againstReason'>"+data+"</span>";
    } },
    
    { "title": "申诉时间", "class":"center","width":"10%", "sortable":false,"data": 'appealTime',"mRender":function (data, display, row) {
    ...
    { "title": "申述理由", "class":"center","width":"8%","sortable":false,"data": 'appealReason',"mRender":function (data, display, row) {
        if(data==null){
            return "暂无";
        }
    	return "<span name='appealReason'>"+data+"</span>";
    } },
    ...
    { "sortable": false,"class": "center","width":"6%","title":"操作","mRender":function (data, display, row) {
    	var str =  '<div class="hidden-sm hidden-xs action-buttons">';
