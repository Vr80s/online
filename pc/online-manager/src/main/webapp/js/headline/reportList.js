...
$(function(){
    ...
    searchCase=[];
    searchCase.push('{"tempMatchType":"9","propertyName":"search_type","propertyValue1":"7","tempType":"String"}');
	var checkbox = '<input type="checkbox" class="ace" onclick="chooseAll(this)" /> <span class="lbl"></span>';
	var objData = [{ "title": checkbox,"class":"center","width":"4%","sortable":false,"data": 'id' ,"mRender":function(data){
        return '<input type="checkbox" value='+data+' class="ace" /><span class="lbl"></span>';
    }},
	{ "title": "ID", "class": "center","width":"4%","sortable": false,"data":"id" },
	{ "title": "文章标题", "class": "center","width":"15%","sortable": false,"data":"title" ,"mRender":function (data) {
	...
	{ "title": "状态", "class": "center","width":"7%","sortable": false,"data":"status","mRender":function (data) {
    	if(data==1){
    		return "已启用";
    	}else{
    		return "已禁用";
    ...
    { "title": "是否推荐", "class": "center","width":"7%","sortable": false,"data":"isRecommend" ,"mRender":function (data) {
    	if(data){
    		return "推荐";
    	}else{
    		return "未推荐";
