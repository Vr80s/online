...
<head>
    ...
    <script>
        ...
        (function () {
            ...
            hm.src = "//hm.baidu.com/hm.js?9905b58e5fa2d9e2dd20bd22ee8ffe8c";
...
<header>
    ...
    <div class="oldModal" id="old">
        <div class="oldBody"><img src="/web/images/pandaLogo.jpg/oldModal.png"><span class="oldX">X</span><a
                class="oldBtn">立即前往</a></div>
    </div>
    <div id="oldModalBack"></div>
    <div class="consult_center">咨询中心</div>
    <div class="online_consult"><a href="http://p.qiao.baidu.com/cps/chat?siteId=11043846&amp;userId=24331702"
                                   target="_blank"><img src="/web/images/zixun.gif"
                                                        alt=""><span>在线咨询</span></a></div>
    <div class="phone_consult">
        <div class="phone_consult_box"><img src="/web/images/tel.gif" alt=""><span class="dianhuazixun">电话咨询</span>
        </div>
        <span class="phone_number">0898-32881833</span></div>
    <div class="sideWeixinBox">
        <div class="sideWeixin"><img src="/web/images/sideWeixinErma.png">
            <p>关注微信</p></div>
    </div>
    <a class="sideWeiboBox" href="http://weibo.com/u/6329861207?refer_flag=1001030102_&amp;is_hot=1" target="_blank">
        <div class="sideWeibo"><img src="/web/images/sideWeiboErma.png">
            <p>关注微博</p></div>
    </a>
    <div class="sideWeixinErma"><img src="/web/images/sideWeixin.png">
        <div class="sideSanjiao"><img src="/web/images/float_sanjiao.png"></div>
    </div>
    <div class="sideWeiboErma"><img src="/web/images/sideWeibopng.png">
        <div class="sideSanjiao1"><img src="/web/images/float_sanjiao.png"></div>
    </div>
    <div class="h_top" onclick="pageScroll();" style="display: none;"><span class="wrap"><img
            src="/web/images/top.png" alt=""><span class="h_top_s">top</span></span></div>
</header>
    ...
    <footer class="indexFooter">
        <div class="content">
            <div class="content-item footer-bodys" style="background-color:#fff;">
                ...
                <div class="trademark">琼ICP备17002789号 Copyright © 2017-2018 熊猫中医 All Rights Reserved <span
                        style="margin-right:5px;"></span><span id="cnzz_stat_icon_1263718355"><a
                        href="http://www.cnzz.com/stat/website.php?web_id=1263718355" target="_blank" title="站长统计"><img
                        border="0" hspace="0" vspace="0" src="./熊猫中医云课堂 - 线上中医教育_files/pic1.gif"></a></span></div>
            </div>
        </div>
    </footer>
</div>
