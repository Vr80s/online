...
//  var articleDetail = '<h1>{{title}}</h1>';
    ...
    RequestService("/medical/doctor/getWritingsByWritingsId",'GET',{writingsId:articleId},function(data){
    	...
    	//获取评论id
        console.log(data.resultObject.articleId);
    	talkId = data.resultObject.articleId;
    	//左侧报道内容渲染
        ...
        $(".forum-hitzan").click(function(){
            RequestService("/online/user/isAlive", "GET", null, function(data) {
                if (data.success == false) {
                    ...
                    RequestService("/bxs/article/updatePraiseSum","GET",{articleId:talkId,praiseSum:praiseSum},function(data){
