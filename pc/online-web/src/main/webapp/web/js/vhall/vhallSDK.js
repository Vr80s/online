 ...
 *  @copyright (c) 2016
 *  @author: wenfeng.lei
 *  @update: Wed Mar 21 2018 14:11:13 GMT+0800 (中国标准时间)
 */
!
function(e) {
    function t(n) {
    ...
    n = function(e, t) {
        ...
        var e = Array.prototype.slice.call(arguments),
            ...
            n = i[t];
        if (n && n.length >= 0) for (var r = 0, a = n.length; r < a; r++) n[r].apply(null, e)
    }, a = function(e, t) {
        var n = i[e];
        if (!n) return !1;
    ...
    e.exports = {
        ...
        updateUserInfo: function(e) {
            ...
            e && (t.username = encodeURIComponent(e)), a.dataToken && (t.token = a.dataToken), $.ajax({
            ...
            if (!$(this).hasClass("disabled")) {
                ...
                if (d.length <= 0) if (r) {
                    ...
                    for (var l = 1; l <= 5; l++) {
                        ...
                        for (var g = 1; g <= 20; g++) {
                            var f = 20 * (l - 1) + g;
                            n = a(f - 1), n && (t += "<li onclick=\"$('" + i.assign + "').setCaret();$('" + i.assign + "').insertAtCaret('" + n + '\');"><img width="24" src="' + s + "Expression_" + f + '@2x.png" /></li>')
                        }
    ...
    var n = i(1),
        ...
        o = (i(3), {
            eventProcessors: {},
            init: function(e) {
                this.options = e, this.pushstream = new PushStream({
                    host: e.domain,
                    port: e.port,
                ...
                }), this.pushstream.addChannel(e.roomid), this.pushstream.connect(), this.bind()
            },
            close: function() {
            ...
            bind: function() {
                ...
                }, n.listen("_updateUserInfo", function(e) {
                    this.options.token = e
                }.bind(this)), this.onevent("online", function(e) {
                    n.trigger("userOnline", e)
                }), this.onevent("offline", function(e) {
                    n.trigger("userOffline", e)
                }), this.onevent("msg", function(e) {
                ...
                }), this.onevent("custom_broadcast", function(e) {
                    n.trigger("customEvent", e.data)
                }), this.onevent("question", function(e) {
                    var t = VHALL_SDK.getUserinfo();
            ...
            sendChat: function(e) {
                if (o.filterWords && o.filterWords.length > 0) {
                    for (var t = !1, i = e.text, r = o.filterWords, a = 0, s = o.filterWords.length; a < s; a++) if (i.indexOf(r[a]) >= 0) {
                        t = !0;
                        break;
                    }
    ...
    e.exports = {
        create: function(e) {
            s = $.extend({}, s, e), $(s.docContent).
            html('<img style="width:100%" src="/xcview/images/no_class_one.png" onerror="this.src = \'//cnstatic01.e.vhall.com/static/img/mobile/doc_error.png\'"/>'),
                    s.doc = $(s.docContent).find("img"), r()
        },
        setter: function(e, t) {
            1 == o.getter("type") ? setTimeout(function() {
                a(e) ? s = $.extend({}, s, e) : s[e] = t, r()
            }, 15e3) : (a(e) ? s = $.extend({}, s, e) : s[e] = t, r())
        },
        getter: function(e) {
            return e ? s[e] : s
        },
    ...
    var n = i(8),
        ...
        d = {
            init: function(e) {
                n ? (s(["//cnstatic01.e.vhall.com/3rdlibs/swfobject/2.2.0/swfobject.js", "//cnstatic01.e.vhall.com/3rdlibs/jquery-object/jqueryObject.js"], function() {
                    c.init(e)
                }), this.exchageWhite = c.exchageWhite) : (this.player = new r(e), this.player.on("_playerError", function(e) {
                    o.trigger("playerError", e)
                }), this.player.on("_playerReady", function() {
                    var e = this;
                    this.on = function(t, i) {
                        ...
                        e.player.seek(t)
                    }), o.trigger("playerReady"), this.player.onready()
                }.bind(this)))
            }
        };
    e.exports = d
    ...
    function n(e) {
        this.content = c(JSON.parse(e.content).text), this.avatar = e.avatar ? e.avatar : "//cnstatic01.e.vhall.com/static/images/watch/head50.png", this.role = e.user_role, this.user_name = e.user_name, this.time = e.created_at, this.user_id = e.user_id
    }
    function r(e) {
        var t = new Date;
    ...
    e.exports = {
        ...
        sendRecordChat: function(e) {
            ...
            if (this.filterWords && this.filterWords.length > 0) {
                var t = sessionStorage.getItem("historyFilter"),
                    i = [];
                t && (i = JSON.parse(t));
                for (var n = !1, r = e.content, a = this.filterWords, s = 0, c = this.filterWords.length; s < c; s++) if (r.indexOf(a[s]) >= 0) {
                    i.length >= 20 && i.pop(), i.unshift(e), sessionStorage.setItem("historyFilter", JSON.stringify(i)), n = !0;
                    break;
                }
            ...
            return this.sign ? 1 != VHALL_SDK.getRoominfo().openQuestion ? o.trigger("error", {
                ...
                success: function(e) {
                    if ("200" == e.code) {
                        var t = [],
                            i = 0;
                        for (e.data.length; i < e.data.length; i++) e.data[i].content = c(e.data[i].content), e.data[i].answer && (e.data[i].answer.content = c(e.data[i].answer.content)), t.push({
                            data: e.data[i]
                        });
        ...
        getNotice: function(e) {
            return e = e ? e : 1, this.sign ? void $.ajax({
    ...
    function n(e) {
        return this.sourceType = 0, this.queryTime = 0, this.querySetTimeId = 0, this.slowSetTimeId = 0, this.stream = e.stream, this.clientList = {}, this.$videoCont = $(e.videoCont), this.type = h.getter("type"), this.currentLine = "", this.lines = e.lines, this.definitions = e.definitions, this.playSource = {
            defaultLines: {},
            play_token: "",
            lines: {}
        }, this.api_host = e.against_url, this.default_token = e.against_token, this.init(e), this
    }
    function r(e) {
        for (var t = window.crcTable || (window.crcTable = w()), i = -1, n = 0; n < e.length; n++) i = i >>> 8 ^ t[255 & (i ^ e.charCodeAt(n))];
        return (i ^ -1) >>> 0
    }
    function a(e) {
        var t = e.split("_"),
            i = t[0].split("").reverse().join("");
        return i = r(i).toString(16).toUpperCase(), i + "_" + t[1]
    }
    function o(e) {
        0 != e.lines.length && (e.playSource.default_token = a(e.default_token), e.lines.forEach(function(t) {
            var i = t.name.replace(/\D/g, "");
            if (e.playSource.defaultLines[i] || (e.playSource.defaultLines[i] = {}), 1 == e.type) e.playSource.defaultLines[i].same = t.srv.replace("{stream}", e.stream), e.definitions.forEach(function(n) {
    ...
    function s(e, t, i, n) {
        $.ajax({
            ...
            success: function(e) {
                if ("200" == e.code) {
                    if (i.playSource.play_token = a(e.data.token), 1 == i.type && e.data.hls_urls) for (var t in e.data.hls_urls) e.data.hls_urls[t].forEach(function(e) {
                        ...
                        i.playSource.lines[n] || (i.playSource.lines[n] = {}), i.playSource.lines[n][t] = e.hls_url
                    });
                    else if (3 == i.type) {
                        var n = e.data.hls_domainnames || e.data.mp4_domainnames;
                        n.forEach(function(e) {
                            var t = e.line.replace(/\D/g, "");
                            i.playSource.lines[t] || (i.playSource.lines[t] = {}), i.playSource.lines[t][i.currDefinitions] = e.hls_domainname || e.mp4_domainname
                        })
                    }
                    i.sourceType = 1
                }
            ...
            complete: function(e, t) {
                ...
                console.log(i.playSource), clearInterval(i.querySetTimeId), i.queryTime = 0, i.querySetTimeId = setInterval(function() {
                    i.queryTime++, i.queryTime > b && (clearInterval(i.querySetTimeId), i.queryTime = 0, d.call(i))
                }, 1e3), n && n(i)
            }
        })
    }
    function c(e) {
        ...
        var t = g.call(e);
        e.currentLine = "1", e.currCdnServerLine = t[e.currentLine], e.video = e.createVideo(e.$videoCont), m.init(), e.bind(), e.trigger("_playerReady")
    }
    function d(e) {
    ...
    function u(e, t) {
        for (var i = "", e = Object.keys(e), n = 0; n < e.length; n++) if (t.indexOf(e[n]) == -1) {
            i = e[n];
            break;
        }
        return i
    ...
    n.prototype.init = function() {
        this.on("_streamOver", function() {
            clearInterval(this.querySetTimeId), this.queryTime = 0
        }.bind(this)), l.call(this, c)
        ...
        if (2 != this.type) {
            ...
            Object.keys(t).forEach(function(t) {
                e.push("线路" + t)
            }), this.trigger("canPlayLines", e), this.getCanPlayDefinitions()
        }
        ...
        t.attr("webkit-playsinline", ""), t.attr("playsinline", ""), t.attr("x5-playsinline", ""), t.attr("x-webkit-airplay", "allow"), t.attr("controls", ""), t.css({
            width: "100%",
            height: "100%"
        });
        var i = f.call(this);
        return _src = this.currCdnServerLine[this.currDefinitions] + "?token=" + i, p("地址类型:" + (this.sourceType ? "防盗链" : "原始") + " 播放地址:" + _src), t.attr("src", _src), e.append(t), t.load(), t[0]
    }, n.prototype.seek = function(e) {
        this.type && (this.video.currentTime = e, this.trigger("seek", e))
    }, n.prototype.on = function(e, t) {
        this.clientList[e] || (this.clientList[e] = []), this.clientList[e].push(t)
    }, n.prototype.trigger = function() {
        var e = Array.prototype.slice.call(arguments),
            t = Array.prototype.shift.call(e),
            i = this.clientList[t];
        if (i && i.length >= 0) for (var n = 0, r = i.length; n < r; n++) i[n].apply(null, e)
    }, n.prototype.bind = function() {
        var e = this;
        this.video.addEventListener("waiting", function() {
            p("开始卡顿,当前线路:" + e.currentLine), clearTimeout(e.slowSetTimeId), e.slowSetTimeId = setTimeout(function() {
                var t = g.call(e);
                if (4 == e.video.readyState) return void p("不卡了,当前线路:" + e.currentLine);
                clearInterval(e.querySetTimeId), e.queryTime = 0, A.indexOf(e.currentLine) == -1 && A.push(e.currentLine);
                var i = u(t, A);
                ...
                for (var n = r.length - 1; n >= 0; n--) {
                    ...
                    if (e > parseFloat(a.created_at)) {
                        ...
                        if ("change_showtype" === a.type) {
                            h.setter("isBoard", a.showType), y.setter({});
                            break;
                        }
                    }
                }
        ...
        e = e.replace(/\D/g, "");
        var t = "";
        this.currentLine = e, this.currCdnServerLine = g.call(this, e), t = this.currCdnServerLine[this.currDefinitions] + "?token=" + f.call(this), p("地址类型:" + (this.sourceType ? "防盗链" : "原始") + " 播放地址:" + t);
        ...
        var t = "";
        if (1 == this.type) {
            this.currCdnServerLine[_[e]] && (this.currDefinitions = _[e], t = this.currCdnServerLine[this.currDefinitions] + "?token=" + f.call(this)), p("地址类型:" + (this.sourceType ? "防盗链" : "原始") + " 播放地址:" + t);
            var i = this.video.paused;
            this.video.src = t, this.video.load(), !i && this.video.play()
        } else if (3 == this.type) {
            ...
            clearInterval(this.querySetTimeId), this.queryTime = 0, s(n, r, this, function(e) {
                e.video.dataset.ct = e.video.currentTime;
                var t = e.video.paused;
                e.video.src = e.currCdnServerLine[e.currDefinitions] + "?token=" + f.call(e), p("地址类型:" + (e.sourceType ? "防盗链" : "原始") + " 播放地址:" + e.video.src), e.video.load(), e.video.dataset.ct && (e.video.currentTime = e.video.dataset.ct), !t && e.video.play()
            })
        }
    }, e.exports = n
}, function(e, t, i) {
    ...
    var r = i(2),
        ...
        c = function(e) {
            ...
            function i(i) {
                ...
                if (console.log(a), i.success) return n(parseInt(a)), !1;
            ...
            $videoContent = $(e.videoCont), $docContent = $(e.docContent), $docContent.css({
...
"background-image": "url(http://test-wx.ixincheng.com/xcview/images/book.png)",
            ...
            e.videoCont && $videoContent.append('<div style="width:100%;height:100%;" id="' + a + '"></div>'), e.docContent && $docContent.append("<div style='width:100%;height:100%;' id='" + o + "'></div><div style='width:1px;height:1px;' id='" + s + "'></div>");
            var p = "10.0.0",
                g = "//cnstatic01.e.vhall.com/3rdlibs/swfobject/2.2.0/expressInstall.swf",
                f = {};
            f.quality = "high", f.bgcolor = "#363636", f.allowscriptaccess = "always", f.allowfullscreen = "true", f.allowFullScreenInteractive = "true", f.wmode = e.isFlashVR ? "direct" : "transparent";
            var h = {};
            h.styleclass = "Intranet_Runner", h.name = "Intranet_Runner", h.align = "middle", !e.flash_doc_url || swfobject.embedSWF(e.flash_doc_url, o, "100%", "100%", p, g, e.flashvar, f, h, d), !e.flash_whiteBoard_url || swfobject.embedSWF(e.flash_whiteBoard_url, s, "100%", "100%", p, g, e.flashvar, f, h, i), !e.flash_video_url || swfobject.embedSWF(e.flash_video_url, a, "100%", "100%", p, g, e.flashvar, f, h, c), swfobject.createCSS(".Intranet_Runner", "display:block;text-align:left;position:absolute;")
        };
    !
    function(e) {
        e.sendMsgToFlash = function(e, t) {
            ...
            try {
                ...
                return t = $.parseJSON(i), e.sendMsgToFlash(t.type, t), 3 == r.getter("type") && "*changeShowType" == t.type && n(parseInt(t.showType)), !0
            } catch (e) {
                return console.log("parse JSON error:" + e.message), !1
            }
        }, e.sendRecordMsg = function(e, t) {
            try {
                return sendEveToFlash(e, t), !0
            } catch (e) {
                return ldebug("parse JSON error:" + e.message), !1
            }
        }
    }(window), e.exports.init = c, e.exports.exchageWhite = n
}, function(e, t, i) {
    function n(e) {
        if ("undefined" == typeof e) return e = {}, console.error("请先阅读文档传入正确参数");
        ...
        VHALL_SDK.options = t, a(["//cnstatic01.e.vhall.com/3rdlibs/nginx-push-stream/0.5.1/pushstream.js", "//cnstatic01.e.vhall.com/3rdlibs/socket.io/1.3.5/socket.io.min.js", "//cnstatic01.e.vhall.com/3rdlibs/jquery-json/2.4.0/jquery.json.min.js", "//cnstatic01.e.vhall.com/3rdlibs/base64/base64.js"], function() {
            r(t)
        })
    }
    var r = i(18),
    ...
    function o(e, t) {
        a(e, t), 1 == e.webinarStatus && (c.init({
            ...
            token: e.socketToken,
            app: "vhall"
        })), g.sign = 1, t.facedom && t.textdom && $(t.facedom).qqFace({
            assign: t.textdom,
    ...
    function n() {
        var e = r();
        return e = e.match(/(https?:|rtmp:)?(\/\/)?([a-zA-Z0-9]+\.)?([a-zA-Z0-9]+\.)+[a-zA-Z0-9]+/), e && (e = e[0]), e
    }
    function r() {
        var e = "";
    ...
    function s() {
        var e = o();
        e.tt = a(), 1 == R.webinar_type ? (e.sd = n(), e.browser = L.ua, e._bc = w, e._bt = S) : e.fd = r(), e.ua = L.ua, e.tf = L.tf, E({
            k: v.heart_beat,
    ...
    function c() {
        var e = o();
        1 == R.webinar_type ? (e.sd = n(), e.browser = L.ua) : e.fd = r(), E({
            k: v.player_pause,
            id: String(L.s) + (new Date).getTime(),
            s: L.s,
            token: e
    ...
    function u() {
        var e = o();
        1 == R.webinar_type ? (e.sd = n(), e.browser = L.ua) : e.fd = r(), e.tt = a(), e._bc = _, e._bt = "", E({
            k: v.close_stream,
            id: String(L.s) + (new Date).getTime(),
            s: L.s,
            token: e
    ...
    function p() {
        var e = o();
        1 == R.webinar_type ? (e.sd = n(), e.browser = L.ua) : e.fd = r(), e.tt = (new Date).getTime() - b, e._bc = w, e._bt = S, E({
            k: v.lag,
            id: String(L.s) + (new Date).getTime(),
            s: L.s,
            token: e
    ...
    function g() {
        var e = f.get(),
            t = h.get();
        R.webinar_id = e.id, R.webinar_type = e.type, R.sessionId = t.sessionId, R.join_uid = t.userid, 1 == e.type && (v = {
            open_stream: 52001,
            close_stream: 52002,
            heart_beat: 52003,
            player_pause: 52004,
            ...
            var e = 1;
            $("video#vhall-h5-player")[0] ? e = $("video#vhall-h5-player")[0].paused : $("audio")[0] && (e = $("audio")[0].paused), k || e || (l(this.src), clearInterval(k), k = setInterval(function() {
                s(), 1 != R.webinar_type && p(), w = 0
            }, 6e4))
        }, 1e3), $("video#vhall-h5-player")[0] && ($("video#vhall-h5-player")[0].addEventListener("play", function() {
            b = (new Date).getTime(), clearInterval(k), k = setInterval(function() {
                s(), 1 != R.webinar_type && p(), w = 0
            }, 6e4), A && (l(this.src), A = !1), x = 0, d()
        }, !1), $("video#vhall-h5-player")[0].addEventListener("timeupdate", function() {
            x && (S = (new Date).getTime() - x)
        }, !1), $("video#vhall-h5-player")[0].addEventListener("pause", function() {
            x = 0, clearInterval(k), c()
        }, !1), $("video#vhall-h5-player")[0].addEventListener("ended", function() {
            x = 0, clearInterval(k)
        }, !1), $("video#vhall-h5-player")[0].addEventListener("waiting", function() {
            w++, _++, x = (new Date).getTime()
        }))
    }
    var f = i(2),
        h = i(3),
        ...
        E = function(e) {
            e.token = Base64.encode(JSON.stringify(e.token)), $.getJSON(y, e, function() {})
        },
        T = {},
        j = null;
    j = function(e, t) {
        ...
        var e = Array.prototype.slice.call(arguments),
            ...
            i = T[t];
        if (i && i.length >= 0) for (var n = 0, r = i.length; n < r; n++) i[n].apply(null, e)
    }, j("changeline", function(e, t) {
        u(e), l(t)
    }), m.init = g, e.exports = m
}, function(e, t, i) {
    function n(e) {
        switch (e.type) {
        case "*disablechat":
            d.getter("userid") == e.user_id && d.setter("is_gag", 1), r.trigger("disableChat", e.user_id);
            break;
        case "*permitchat":
            d.getter("userid") == e.user_id && d.setter("is_gag", 0), r.trigger("permitChat", e.user_id);
            break;
        case "*kickout":
            d.getter("userid") == e.user_id && d.setter("is_kickout", 1), r.trigger("kickout", e.user_id);
            break;
        case "*kickoutrestore":
            d.getter("userid") == e.user_id && d.setter("is_kickout", 0), r.trigger("kickoutRestore", e.user_id);
            break;
        case "*forbidchat":
            "1" === e.status ? d.setter("forbidchat", 1) : d.setter("forbidchat", 0), r.trigger("forbidChat", e.status);
            break;
        case "*question":
            "1" == e.status ? c.setter("openQuestion", 1) : c.setter("openQuestion", 0), r.trigger("questionSwitch", {
                status: e.status
            });
            break;
        case "*publish_start":
        ...
        case "*over":
            if (o) {
                var t = {};
                t.desc = "活动结束", c.setter("type", 3), window.sendMsgToFlash("*over", $.toJSON(t))
            } else setTimeout(function() {
                r.trigger("streamOver"), l.player.trigger("_streamOver")
            }, 15e3);
            break;
        case "*publishStart":
    ...
    var r = i(1),
        ...
        u = (i(6), {
            init: function(e) {
                this.options = e, this.socket = io.connect(e.srv, {
                    query: "token=" + e.token + "&app=" + (e.app || "vhall"),
                    transports: a ? ["polling"] : ["websocket", "polling"]
                }), this.bind()
            },
            bind: function() {
                this.socket.on("online", function(e) {}), this.socket.on("cmd", function(e) {
                    try {
                        e = $.parseJSON(e)
                    } catch (t) {
                        e = e
                    ...
                    n(e)
                }), this.socket.on("flashMsg", function(e) {
    ...
    function i() {
        var e = !1;
        return "Microsoft Internet Explorer" == navigator.appName && ("MSIE9.0" != navigator.appVersion.split(";")[1].replace(/[ ]/g, "") && "MSIE8.0" != navigator.appVersion.split(";")[1].replace(/[ ]/g, "") || (e = !0)), e
    }
    e.exports = i()
}, function(e, t) {
    function i(e) {
    ...
    function n(e, t) {
        ...
        var i = o.getter("webConfig").chat_limit,
            n = 140;
        return "1" == i && (n = 1e3), t.text && $.trim(t.text).length > n ? a.trigger(e, {
            code: 10003,
            msg: u[10003]
    ...
    function d(e, t) {
        ...
        if (t.singleton) {
            var a = m++;
            i = y || (y = s(t)), n = l.bind(null, i, a, !1), r = l.bind(null, i, a, !0)
