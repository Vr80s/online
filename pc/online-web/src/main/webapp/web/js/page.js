	...
	$.fn.pagination = function(maxentries, opts) {
			...
			$(".page-btn").on("click", function() {
				...
				if(goPage > -1 && goPage < allPage) {
					...
					$("#Paginations").pagination(allPage);
					if($(".page #Paginations"))
					$("#Paginations").pagination(allPage);
				}
				//清空用户跳转页数
			...
			function paginationClickHandler(evt) {
				if($(evt.target).data('page_id') == undefined){
					if($(evt.target).parent().hasClass("prev") == true){
						$("body, html").scrollTop(0);
						if($(".page #Paginations").css("display") == "block"){
							var links,
						...
						$("body, html").scrollTop(0);
						var links,
							new_current_page = parseInt($("#Paginations .pagination .current").text()),
							continuePropagation = selectPage(new_current_page);
						if(!continuePropagation) {
							evt.stopPropagation();
						}
			...
			function selectPage(new_current_page) {
				...
				$("#Paginations .pagination a:not([class='current']):not([class='next']):not([class='prev'])").hover(function() {
					$(this).css({
						"color": "#fff",
						"border": "none",
				...
				$(".page #Paginations .pagination .prev").hover(function() {
				...
				$(".page #Paginations .pagination .next").hover(function() {
					$(this).css("border", "1px solid #2cb82c");
