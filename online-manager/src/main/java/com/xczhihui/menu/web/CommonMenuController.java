...
public class CommonMenuController {
	...
	public ModelAndView index() {
		ModelAndView mav = new ModelAndView("menumanager/menu");
		return mav;
	}
	...
	public TableVo list(TableVo tableVo) {
		...
		/*
		 * Group time_startGroup = groups.findByName("time_start"); Group
		 * time_endGroup = groups.findByName("time_end");
		 */
	...
	public ResponseObject add(MenuVo menu) throws InvocationTargetException,
		...
		entity.setLevel("1");
		entity.setStatus(1);
		entity.setYunStatus(1);
		entity.setBoStatus(1);
