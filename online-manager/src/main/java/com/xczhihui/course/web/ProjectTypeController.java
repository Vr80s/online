...
import com.xczhihui.course.service.ProjectTypeService;
...
public class ProjectTypeController {
	...
	public TableVo list(TableVo tableVo) {
		...
		if (searchType != null) {
			p.setType(Integer.parseInt(searchType.getPropertyValue1()
					.toString()));
		}
	...
	@ResponseBody
	public ResponseObject add(Project project)
		...
		Project existsEntity = service.findProjectTypeByNameAndByType(
		...
		project.setCreatePerson(ManagerUserUtil.getName());
	...
	public ResponseObject update(Project project)
		...
		if (project == null || project.getName() == null
				|| project.getIcon() == null || project.getLinkType() == null
				|| project.getLinkCondition() == null) {
		...
		if (existsEntity != null
				&& !existsEntity.getId().equals(project.getId())) {
