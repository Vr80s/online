...
public class FieldController {
	...
	public TableVo list(TableVo tableVo) {
		...
		// searchVo.setTime_start(DateUtil.parseDate(time_startGroup.getPropertyValue1().toString(),
		// "yyyy-MM-dd"));
		// }
		...
		Page<MedicalField> page = service.findMenuPage(searchVo, currentPage,
				pageSize);
	...
	@ResponseBody
	public ResponseObject add(MedicalField MedicalField)
		...
		MedicalField existsEntity = service.findMedicalFieldByName(entity
				.getName());
	...
	@ResponseBody
	public ResponseObject update(MedicalField MedicalField)
			throws InvocationTargetException, IllegalAccessException {
