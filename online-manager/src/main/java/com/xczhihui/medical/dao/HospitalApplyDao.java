...
public class HospitalApplyDao extends HibernateDao<MedicalHospitalApply> {
	...
	public Page<MedicalHospitalApply> list(MedicalHospitalApply searchVo,
		...
		StringBuilder hql = new StringBuilder(
				"select id,company,business_license_no,"
		...
		Page<MedicalHospitalApply> page = this.findPageBySQL(hql.toString(),
				paramMap, MedicalHospitalApply.class, currentPage, pageSize);
