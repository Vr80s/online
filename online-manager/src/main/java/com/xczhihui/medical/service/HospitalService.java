...
public interface HospitalService {
	 ...
	 * @return
	 */
	Page<MedicalHospital> findMedicalHospitalPage(
	 ...
	 * 增加医馆详情
	 */
	void updateMedicalHospitalDetail(String medicalHospitalId, String picture1,
			String picture2, String picture3, String picture4, String picture5,
			String picture6, String picture7, String picture8, String picture9);
	...
	Page<MedicalHospital> findRecMedicalHospitalPage(MedicalHospital searchVo,
