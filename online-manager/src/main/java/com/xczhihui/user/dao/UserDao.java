...
public class UserDao extends HibernateDao<User> {
	...
	public List<OnlineUser> findUsersByLikeUserName(String userName) {
		...
		RowMapper<OnlineUser> mapper = BeanPropertyRowMapper
				.newInstance(OnlineUser.class);
		return this.getNamedParameterJdbcTemplate().query(sql, params, mapper);
	}
	...
	public User getUserByLoginName(String loginName) {
		return this
				.findOneEntitiyByProperty(User.class, "loginName", loginName);
	}
	...
	public Page<User> findUserPage(Boolean isDelete, String roleId,
		...
		return this.findPageBySQL(sql, paramMap, User.class, pageNumber,
				pageSize);
	}
