...
public class AskTagController {
	...
	public TableVo findTagList(TableVo tableVo) {
		...
		if (citesSortSearch != null) {
			searchVo.setCitesSort(citesSortSearch.getPropertyValue1()
					.toString());
		}

		if (monthSortSearch != null) {
			searchVo.setMonthSort(monthSortSearch.getPropertyValue1()
					.toString());
		}
	...
	@ResponseBody
	public ResponseObject update(TagVo tagVo) throws InvocationTargetException,
			IllegalAccessException {
		ResponseObject responseObject = new ResponseObject();
