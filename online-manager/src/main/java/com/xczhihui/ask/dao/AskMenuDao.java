...
public class AskMenuDao extends HibernateDao<Menu> {
	...
	public Page<MenuVo> findCloudClassMenuPage(MenuVo menuVo, int pageNumber,
		...
		StringBuilder sql = new StringBuilder(
				"select om.id,om.name,om.remark,om.create_person,om.create_time,om.bo_status,om.bo_sort,om.ask_limit"
		...
		for (MenuVo m : ms.getItems()) {
			...
			List<MenuVo> tags = this.getNamedParameterJdbcTemplate().query(
					tagCountSql, paramMap,
					BeanPropertyRowMapper.newInstance(MenuVo.class));
	...
	public String deleteById(String id) {
		...
		params3.put("id", id);
		List<Question> query3 = this.getNamedParameterJdbcTemplate().query(
				sql3, params3,
