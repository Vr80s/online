    ...
    private void sendEnchashmentMessage(EnchashmentApplyInfo e, String operator) {
        try {
            ...
            if (success) {
                ...
                weixinParams.put("keyword2", e.getEnchashmentSum().stripTrailingZeros().toPlainString() + "(元)");
                ...
                weixinParams.put("keyword1", e.getEnchashmentSum().stripTrailingZeros().toPlainString() + "(元)");
