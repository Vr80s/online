    ...
    var objData = [{
        ...
        {"title": "年龄", "class": "center", "width": "6%", "sortable": false, "data": 'age'},
        {
            ...
            "mRender": function (data) {
                if (data == 1) {
                    return "<span name='zt'>男</span>";
                } else if (data == 0) {
                    return "<span name='zt'>女</span>";
                } else {
                    return "<span name='zt'>未知</span>";
                }
            }
        },
        {"title": "籍贯", "class": "center", "width": "6%", "sortable": false, "data": 'nativePlace'},
        {
            ...
            "mRender": function (data) {
                if (data == 1) {
                    return "<span name='zt'>小学</span>";
                } else if (data == 2) {
                    return "<span name='zt'>初中</span>";
                } else if (data == 3) {
                    return "<span name='zt'>高中</span>";
                }
                else if (data == 4) {
                    return "<span name='zt'>大专</span>";
                }
                else if (data == 5) {
                    return "<span name='zt'>本科</span>";
                }
                else if (data == 6) {
                    return "<span name='zt'>研究生</span>";
                }
                else if (data == 7) {
                    return "<span name='zt'>博士生</span>";
                }
                else if (data == 8) {
                    return "<span name='zt'>博士后</span>";
                } else {
                    return "<span name='zt'>无</span>";
                }
            }
        },
        {"title": "报名时间", "class": "center", "width": "8%", "sortable": false, "data": 'createTime',
            "mRender": function (data) {
            ...
            }},
        {
            ...
            "mRender": function (data) {
                if (data == 1) {
                    return "<span name='zt'>是</span>";
                } else {
                    return "<span name='zt'>否</span>";
                }
            }
        },
        {
