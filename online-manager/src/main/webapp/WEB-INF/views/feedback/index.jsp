        ...
        <div class="profile-info-row">
            ...
            <table frame=void>
                <tr>
                    ...
                    <td>
                        <div class="profile-info-value searchTr">
                            <input type="text" class="propertyValue1" name="q_name" id="q_title" placeholder="意见标题"/>
                    ...
                    <td>
                        <div class="profile-info-value searchTr">
                            <input type="text" class="datetime-picker" name="time_start" id="time_start"
                                   placeholder="开始创建时间"/>
                    ...
                    <td>
                        <div class="profile-info-value searchTr">
                            <input type="text" class="datetime-picker" name="time_end" id="time_end"
                                   placeholder="结束创建时间"/>
                        </div>
                    </td>
                    <td>
                        <div class="profile-info-value searchTr">
                            ...
                            <!-- 4等于 5包含 6小于 7大于  8小于等于  9大于等于  10之间 -->
...
<div id="feedBackDialog" class="hide">
    <form class="form-horizontal" id="addfeedBack-form" method="post" action="">
        ...
        <div class="form-group row my_setPadding">
            ...
            <div class="col-xs-12 col-sm-9">
                <textarea style="position: relative; resize: none;width:345px;font-size: 12px" maxlength="125"
                          name="replytext" id="add_replytext" class="{required:true}"></textarea>
            </div>
        </div>
        <div class="form-group row">
        ...
        <div class="form-group row my_setPadding">
            ...
            >意见描述:</label>
            <div class="col-lg-7 col-xs-9">
                <textarea cols="45" rows="5" id="add_context" class="" readonly="readonly"
                          style="width:345px;font-size: 12px"></textarea>
            </div>
        </div>
    </form>
</div>
...
<div id="showfeedBackDialog" class="hide">
    ...
    <div class="form-group row my_setPadding">
        ...
        >意见描述:</label>
        <div class="col-lg-7 col-xs-9">
            <textarea cols="45" rows="5" id="show_context" class="col-xs-12"
                      style="position: relative; resize: none; width:345px;font-size: 12px"
