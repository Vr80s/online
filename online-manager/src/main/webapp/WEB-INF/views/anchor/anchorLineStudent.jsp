                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="profile-info-value searchTr">
                                        <input type="text" placeholder="课程名称" class="propertyValue1"
                                ...
                                <td>
                                    <div class="profile-info-value searchTr">
                                        <input type="text" placeholder="主播名称" class="propertyValue1"
                                               id="search_anchorName" style="width: 150px;">
                                        <input type="hidden" value="search_anchorName" class="propertyName"/>
                                    </div>
                                </td>
                                <td>
...
<script type="text/javascript" src="/js/anchor/anchorLineStudent.js?v=ipandatcm_1.3"></script>