                            ...
                            <tr>
                                <td>
                                    <div class="profile-info-value searchTr">
                                        <input type="text" placeholder="账号" class="propertyValue1" id="search_loginName"
                                               style="width: 150px;">
                                ...
                                <td>
                                    <div class="profile-info-value searchTr">
                                        <input type="text" placeholder="主播名称" class="propertyValue1" id="search_name"
                                               style="width: 150px;">
                                ...
                                <td>
                                    <div class="profile-info-value searchTr">
                                        <input type="text" class="datetime-picker propertyValue1" id="startTime"
                                               name="startTime" placeholder="开始日期" style="width:130px"/>
                                ...
                                <td>
                                    <div class="profile-info-value searchTr">
                                        <input type="text" class="datetime-picker propertyValue1" id="stopTime"
                                               name="stopTime" placeholder="结束日期" style="width:130px"/>
...
<div id="EditCourseDialog" class="hide">
    <form class="form-horizontal" id="updateCourse-form" method="post" action="" style="margin-top: 15px;">
        ...
        <div class="form-group" style="margin-top: 18px;">
            ...
            <div class="col-sm-6">
                <input type="text" name="courseName" id="name" maxlength="20" readonly="readonly"
        ...
        <div class="form-group" style="margin-top: 18px;">
            ...
            <div class="col-sm-6">
                <input type="text" name="vodDivide" id="vod"
                       class="col-xs-10 col-sm-12 {required:true,number:true,range:[0.00,100.00]}">
            </div>
        </div>
        <div class="form-group" style="margin-top: 18px;">
            <label class="col-sm-3 control-label no-padding-right"><font color="red">*</font>直播课分成: </label>
            <div class="col-sm-6">
                <input type="text" name="liveDivide" id="live"
                       class="col-xs-10 col-sm-12 {required:true,number:true,range:[0.00,100.00]}">
            </div>
        </div>
        <div class="form-group" style="margin-top: 18px;">
            ...
            <div class="col-sm-6">
                <input type="text" name="offlineDivide" id="offline"
                       class="col-xs-10 col-sm-12 {required:true,number:true,range:[0.00,100.00]}">
            </div>
        </div>
        <div class="form-group" style="margin-top: 18px;">
            ...
            <div class="col-sm-6">
                <input type="text" name="giftDivide" id="gift"
                       class="col-xs-10 col-sm-12 {required:true,number:true,range:[0.00,100.00]}">
            </div>
        </div>
        <div class="form-group" style="margin-top: 18px;">
            ...
            <div class="col-sm-6">
                <input type="text" name="defaultCount" id="default"
                       class="col-xs-10 col-sm-12 {required:true,number:true,range:[0,100000]}">
            </div>
        </div>
...
<div id="UpdateRecommendSortDialog" class="hide">
    <form class="form-horizontal" id="UpdateRecommendSortFrom" method="post" action="" style="margin-top: 15px;">
        ...
        <div class="form-group" style="margin-top: 18px;">
            ...
            <div class="col-sm-6">
                <input type="text" name="recommendSort" id="recommendSort" onkeyup="value=value.replace(/[^\d]/g,'')"
...
<div id="dialogLoginBusinessDiv"></div>
<div id="LoginBusinessDialog" class="hide">
    <form class="form-horizontal" id="LoginBusinessFrom" method="post" action="" style="margin-top: 15px;">
        <div class="form-group" style="margin-top: 18px;">
            <label class="col-sm-3 control-label no-padding-right">商家账号: </label>
            <div class="col-sm-6">
                <select name="username" class="J-username">
                </select>
            </div>
        </div>
    </form>
