...
<!-- 修改form -->
<div id="dialogEditDiv"></div>
<div id="EditDialog" class="hide">
	<form class="form-horizontal" id="update-form" method="post" action="" style="margin-top: 15px;">
		<div class="form-group" style="margin-top: 18px;">
			 <label class="col-sm-3 control-label no-padding-right" for="apprentice"><font color="red">*</font>是否为徒弟: </label>
			<input type="hidden" name="id" id="id" >
			 <div class="col-sm-3">
				 <select   name="apprentice"  id="apprentice"  class="col-xs-12 col-sm-12 " >
...
<script type="text/javascript" src="/js/medical/entryInformation.js?v=ipandatcm_1.3"></script>