...
<script type="text/javascript" src="js/medical/entryInformationEdit.js"></script>
...
<div id="editDialog" >
	<form id="update-form" class="form-horizontal"  method="post" action="" >
		...
		<input type="hidden" id="userId"  name="userId" value="${MedicalEntryInformation.userId}" >
		<input type="hidden" id="merId"  name="merId" value="${MedicalEntryInformation.merId}" >
		<input type="hidden" id="createTimeStr"  name="createTimeStr" value="${MedicalEntryInformation.createTime}" >
		<div class="form-group" style="margin-top: 18px;">
			<label class="col-sm-1 control-label no-padding-right" for="name"><font color="red">*</font>姓名: </label>
			<div class="col-sm-3">
				<input type="text" name="name"  id="name"  maxlength="20" value="${MedicalEntryInformation.name}" >
			</div>
		</div>

		<div class="form-group"  style="margin-top: 18px;">
			<label class="col-sm-1 control-label no-padding-right"><font color="red">*</font>年龄: </label>
			<div class="col-sm-5" >
				<input type="text" name="age"  id="age"  maxlength="3" onkeyup="value=value.replace(/[^\d]/g,'')" value="${MedicalEntryInformation.age}" >
			</div>
		</div>
		<div class="space-4"></div>
		<div class="form-group"  style="margin-top: 18px;">
			<label class="col-sm-1 control-label no-padding-right"><font color="red">*</font>性别: </label>
			<div class="col-sm-2" >
				<input type="hidden"   id="oldSex"   value="${MedicalEntryInformation.sex}" >
				<select   name="sex"   id="sex"  class="col-xs-12 col-sm-9 " >
		...
		<div class="form-group" style="margin-top: 18px;" >
			...
			<%--<input type="hidden"   id="oldNativePlace"   value="${MedicalEntryInformation.nativePlace}" >--%>
			<div class="col-sm-5" >
		...
		<div class="form-group" style="margin-top: 18px;" >
			...
			<div class="col-sm-1">
				...
				<select   name="education"   id="education"  class="col-xs-12 col-sm-12 " >
		...
		<div class="form-group" style="margin-top: 18px;" >
			...
			<div class="col-sm-3">
				<textarea class="form-control" name="educationExperience" id="educationExperience" rows="3"
		...
		<div class="form-group" style="margin-top: 18px;" >
			...
			<div class="col-sm-3">
				<textarea class="form-control" name="medicalExperience" id="medicalExperience" rows="3"
		...
		<div class="form-group" style="margin-top: 18px;" >
			...
			<div class="col-sm-1">
				<input type="text" name="tel" id="tel"  value="${MedicalEntryInformation.tel}" >
			</div>
		</div>
		<div class="space-4"></div>
		<div class="form-group" style="margin-top: 18px;" >
			<label class="col-sm-1 control-label no-padding-right" for="wechat"><font color="red">*</font>微信号: </label>
			<div class="col-sm-1">
				<input type="text" name="wechat" id="wechat"  value="${MedicalEntryInformation.wechat}" >
			</div>
		</div>
