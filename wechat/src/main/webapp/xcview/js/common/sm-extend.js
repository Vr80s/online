...
+function(j$){
    ...
    var Swiper = function (container, params) {
        ...
        if (s.params.pagination) {
            s.paginationContainer = j$(s.params.pagination);
        ...
        s.updateClasses = function () {
            ...
            if (s.bullets && s.bullets.length > 0) {
                ...
                if (s.paginationContainer.length > 1) {
                    s.bullets.each(function () {
                        if (j$(this).index() === bulletIndex) j$(this).addClass(s.params.bulletActiveClass);
                    });
                }
                else {
            ...
            if (!s.params.loop) {
                if (s.params.prevButton) {
                    if (s.isBeginning) {
                        j$(s.params.prevButton).addClass(s.params.buttonDisabledClass);
                        if (s.params.a11y && s.a11y) s.a11y.disable(j$(s.params.prevButton));
                    }
                    else {
                        j$(s.params.prevButton).removeClass(s.params.buttonDisabledClass);
                        if (s.params.a11y && s.a11y) s.a11y.enable(j$(s.params.prevButton));
                    }
                }
                if (s.params.nextButton) {
                    if (s.isEnd) {
                        j$(s.params.nextButton).addClass(s.params.buttonDisabledClass);
                        if (s.params.a11y && s.a11y) s.a11y.disable(j$(s.params.nextButton));
                    }
                    else {
                        j$(s.params.nextButton).removeClass(s.params.buttonDisabledClass);
                        if (s.params.a11y && s.a11y) s.a11y.enable(j$(s.params.nextButton));
                    }
                }
            }
        };
        ...
        s.initEvents = function (detach) {
            ...
            // Next, Prev, Index
            if (s.params.nextButton) {
                j$(s.params.nextButton)[actionDom]('click', s.onClickNext);
                if (s.params.a11y && s.a11y) j$(s.params.nextButton)[actionDom]('keydown', s.a11y.onEnterKey);
            }
            if (s.params.prevButton) {
                j$(s.params.prevButton)[actionDom]('click', s.onClickPrev);
                if (s.params.a11y && s.a11y) j$(s.params.prevButton)[actionDom]('keydown', s.a11y.onEnterKey);
            }
            if (s.params.pagination && s.params.paginationClickable) {
                j$(s.paginationContainer)[actionDom]('click', '.' + s.params.bulletClass, s.onClickIndex);
            }
        ...
        s.onClickIndex = function (e) {
            e.preventDefault();
            var index = j$(this).index() * s.params.slidesPerGroup;
        ...
        s.updateClickedSlide = function (e) {
            ...
            if (s.params.slideToClickedSlide && s.clickedIndex !== undefined && s.clickedIndex !== s.activeIndex) {
                var slideToIndex = s.clickedIndex,
                    realIndex;
                if (s.params.loop) {
                    realIndex = j$(s.clickedSlide).attr('data-swiper-slide-index');
        ...
        s.onTouchStart = function (e) {
            ...
            if (e.type !== 'touchstart') {
                ...
                if (j$(e.target).is(formElements)) preventDefault = false;
                if (document.activeElement && j$(document.activeElement).is(formElements)) {
        ...
        s.onTouchMove = function (e) {
            ...
            if (isTouchEvent && document.activeElement) {
                if (e.target === document.activeElement && j$(e.target).is(formElements)) {
                    isMoved = true;
                    s.allowClick = false;
                    return;
                }
            ...
            if (s.allowClick) {
                ...
                if (timeDiff < 300 && (touchEndTime - lastClickTime) > 300) {
                    ...
                    clickTimeout = setTimeout(function () {
                        if (!s) return;
                        if (s.params.paginationHide && s.paginationContainer.length > 0 && !j$(e.target).hasClass(s.params.bulletClass)) {
        ...
        s.createLoop = function () {
            ...
            for (i = 0; i < appendSlides.length; i++) {
                s.wrapper.append(j$(appendSlides[i].cloneNode(true)).addClass(s.params.slideDuplicateClass));
            }
            for (i = prependSlides.length - 1; i >= 0; i--) {
                s.wrapper.prepend(j$(prependSlides[i].cloneNode(true)).addClass(s.params.slideDuplicateClass));
            }
        };
                    ...
                    if (s.params.cube.shadow) {
                        if (isH()) {
                            ...
                            if (cubeShadow.length === 0) {
                                cubeShadow = j$('<div class="swiper-cube-shadow"></div>');
                    ...
                    for (var i = 0; i < s.slides.length; i++) {
                        ...
                        if (s.params.cube.slideShadows) {
                            ...
                            if (shadowBefore.length === 0) {
                                shadowBefore = j$('<div class="swiper-slide-shadow-' + (isH() ? 'left' : 'top') + '"></div>');
                                slide.append(shadowBefore);
                            }
                            if (shadowAfter.length === 0) {
                                shadowAfter = j$('<div class="swiper-slide-shadow-' + (isH() ? 'right' : 'bottom') + '"></div>');
            ...
            load: function () {
                if (s.params.watchSlidesVisibility) {
                    s.wrapper.children('.' + s.params.slideVisibleClass).each(function () {
                        s.lazy.loadImageInSlide(j$(this).index());
                    });
                }
                else {
        ...
        s.scrollbar = {
            set: function () {
                ...
                var sb = s.scrollbar;
                sb.track = j$(s.params.scrollbar);
                sb.drag = sb.track.find('.swiper-scrollbar-drag');
                if (sb.drag.length === 0) {
                    sb.drag = j$('<div class="swiper-scrollbar-drag"></div>');
        ...
        // Accessibility tools
        s.a11y = {
            makeFocusable: function (j$el) {
                j$el[0].tabIndex = '0';
                return j$el;
            },
            addRole: function (j$el, role) {
                j$el.attr('role', role);
                return j$el;
            },

            addLabel: function (j$el, label) {
                j$el.attr('aria-label', label);
                return j$el;
            },

            disable: function (j$el) {
                j$el.attr('aria-disabled', true);
                return j$el;
            },

            enable: function (j$el) {
                j$el.attr('aria-disabled', false);
                return j$el;
            },

            onEnterKey: function (event) {
                if (event.keyCode !== 13) return;
                if (j$(event.target).is(s.params.nextButton)) {
                    s.onClickNext(event);
                    if (s.isEnd) {
                ...
                else if (j$(event.target).is(s.params.prevButton)) {
                    s.onClickPrev(event);
                    if (s.isBeginning) {
        ...
        s.cleanupStyles = function () {
            ...
            // Buttons
            if (s.params.prevButton) j$(s.params.prevButton).removeClass(s.params.buttonDisabledClass);
            if (s.params.nextButton) j$(s.params.nextButton).removeClass(s.params.buttonDisabledClass);
...
+function(j$){
    'use strict';
    j$.Swiper.prototype.defaults.pagination = '.page-current .swiper-pagination';

    j$.swiper = function (container, params) {
        return new j$.Swiper(container, params);
    };
    j$.fn.swiper = function (params) {
        return new j$.Swiper(this, params);
    };
    j$.initSwiper = function (pageContainer) {
        var page = j$(pageContainer || document.body);
        ...
        for (var i = 0; i < swipers.length; i++) {
            ...
            var _slider = j$.swiper(swiper[0], params);
            destroySwiperOnRemove(_slider);
        }
    };
    j$.reinitSwiper = function (pageContainer) {
        var page = j$(pageContainer || '.page-current');
...
+function(j$){
    ...
    var PhotoBrowser = function (params) {
        ...
        pb.open = function (index) {
            ...
            if (pb.params.type === 'standalone') {
                j$(pb.params.container).append(htmlTemplate);
            }
            if (pb.params.type === 'popup') {
                pb.popup = j$.popup('<div class="popup photo-browser-popup">' + htmlTemplate + '</div>');
                j$(pb.popup).on('closed', pb.onPopupClose);
            }
            if (pb.params.type === 'page') {
                j$(document).on('pageBeforeInit', pb.onPageBeforeInit);
                j$(document).on('pageBeforeRemove', pb.onPageBeforeRemove);
                if (!pb.params.view) pb.params.view = j$.mainView;
        ...
        pb.onPopupClose = function () {
            pb.close();
            j$(pb.popup).off('pageBeforeInit', pb.onPopupClose);
        };
        pb.onPageBeforeInit = function (e) {
            if (e.detail.page.name === 'photo-browser-slides') {
                pb.layout(pb.openIndex);
            }
            j$(document).off('pageBeforeInit', pb.onPageBeforeInit);
        };
        pb.onPageBeforeRemove = function (e) {
            if (e.detail.page.name === 'photo-browser-slides') {
                pb.close();
            }
            j$(document).off('pageBeforeRemove', pb.onPageBeforeRemove);
        };
        ...
        pb.onSliderTransitionStart = function (swiper) {
            ...
            j$('.photo-browser-prev, .photo-browser-next').removeClass('photo-browser-link-inactive');

            if (swiper.isBeginning && !pb.params.loop) {
                j$('.photo-browser-prev').addClass('photo-browser-link-inactive');
            }
            if (swiper.isEnd && !pb.params.loop) {
                j$('.photo-browser-next').addClass('photo-browser-link-inactive');
            }
        ...
        pb.layout = function (index) {
            if (pb.params.type === 'page') {
                pb.container = j$('.photo-browser-swiper-container').parents('.view');
            }
            else {
                pb.container = j$('.photo-browser');
            }
            if (pb.params.type === 'standalone') {
                pb.container.addClass('photo-browser-in');
                // j$.sizeNavbars(pb.container);
            }
            ...
            var sliderSettings = {
                ...
                onDoubleTap: function (swiper, e) {
                    pb.toggleZoom(j$(e.target).parents('.photo-browser-slide'));
                ...
                onLazyImageReady: function (swiper, slide, img) {
                    j$(slide).removeClass('photo-browser-slide-lazy');
            ...
            pb.swiper = j$.swiper(pb.swiperContainer, sliderSettings);
            if (index === 0) {
        ...
        pb.onSlideTouchStart = function (e) {
            ...
            if (j$.device.os === 'android') e.preventDefault();
            imageIsTouched = true;
        ...
        pb.onSlideTouchMove = function (e) {
            ...
            if (!imageIsMoved) {
                ...
                imageStartX = j$.getTranslate(gestureImgWrap[0], 'x') || 0;
                imageStartY = j$.getTranslate(gestureImgWrap[0], 'y') || 0;
    ...
    j$.photoBrowser = function (params) {
        j$.extend(params, j$.photoBrowser.prototype.defaults);
        return new PhotoBrowser(params);
    };

    j$.photoBrowser.prototype = {
        defaults: {}
    };
