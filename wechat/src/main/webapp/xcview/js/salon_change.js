...
function() {
	...
	function() {
		...
		$(".send_img").css('right', '0.4rem');
		$(".coze_bottom").css("bottom", "0");
		$(".face_img01").css("background", "url(/xcview/images/face.png)");
		$(".face_img01").css("background-size", "100% 100%");
	});
	...
	if (result.lineState != 3) { // 直播走里面
		...
		function() {
			...
			$(".coze_bottom").css('bottom', '0rem'); /* $("#mywords").css('width','11.9rem'); */
			 ...
			 * no-repeat');
			 */
			$(".send_img").css('background-size', '100% 100%'); /* $(".give_a1_span02").show(); */
...
/*$(".share_to_one").click(function() {
	...
	// 打赏
	$(".give_a1_span02").click(function() { /* $(".facebox-mobile").hide(); */
	...
	$(".send_img").click(function() {
		if (lineState == 1) { // zhi'bo
			$(".coze_bottom").css("bottom", "0rem"); /* $(".give_a1_span02").show(); */
			/* $("#face").hide(); */
			/* $("#mywords").css('width','11.8rem'); */
			$(".send_img").css("right", "0.2rem"); /* $("#mywords").css("width","11.9rem"); */
			/* $(".give_a1_img").show(); */
		}
	});
	...
	function() { /* $("#mywords").css('width','13.65rem'); */
		$(".coze_bottom").css("bottom", "3.14rem");
		$(".face_img01").css('background', 'url(/xcview/images/jianpan.png) no-repeat');
		$(".face_img01").css('background-size', '100% 100%');
	...
	for (i = 0; i < aBtn6.length; i++) {
		...
		function() {
			for (i = 0; i < aBtn6.length; i++) {
				...
				$(aBtn6[i]).find('.give_lable1_span').removeClass('give_lable1_span1');
			}
			$(this).addClass('givebg');
			$(this).find('.give_money1').css('color', '#fff');
			$(this).find('.give_lable1_span').addClass('give_lable1_span1');
		})
	}
});
