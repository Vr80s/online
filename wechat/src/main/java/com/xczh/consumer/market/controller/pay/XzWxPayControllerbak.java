...
// **/
//@Controller
//@RequestMapping("/xczh/pay1")
//public class XzWxPayControllerbak {
//
//	@Autowired
...
//
//	private static final org.slf4j.Logger LOGGER = LoggerFactory.getLogger(XzWxPayControllerbak.class);
//
//	/**
...
//		Map<String, String> retob2j = new HashMap<String, String>();
//		retobj.put("ok", "false");
