...
public class AuthInterceptor implements HandlerInterceptor, HandlerMethodArgumentResolver {
    ...
    private static List<String> noNeedAuthPaths = Arrays.asList("/xczh/user/**", "/xczh/share/**", "/xczh/qq/**",
            ...
            "/xczh/enrol/enrollmentRegulations","/xczh/myinfo/showWallet", "/xczh/page/course/*", "/xczh/article/view/*", "/xczh/medical/doctorPostsCommentList",
            "/xczh/medical/doctorPostsList","/xczh/medical/doctorPostsCommentList","/xczh/medical/doctorPostsLikeList");
