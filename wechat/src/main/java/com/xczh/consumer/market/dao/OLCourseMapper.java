...
public class OLCourseMapper extends BasicSimpleDao {
	...
	public List<CourseVo> offLineClass(int number, int pageSize, 
		...
		return super.queryPage(JdbcUtil.getCurrentConnection(),all.toString(),number,pageSize,CourseVo.class);
	}
}
