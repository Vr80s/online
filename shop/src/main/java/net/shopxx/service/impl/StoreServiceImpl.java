 ...
 * FileId: R0Mwemy8EDwj1hxMca1R9i/eomnRcucN
 */
...
public class StoreServiceImpl extends BaseServiceImpl<Store, Long> implements StoreService {
	...
	@Override
	public Store findByBusinessId(Long businessId) {
		Business b = businessService.find(businessId);
		return storeDao.find("business", b);
	}
