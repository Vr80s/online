 ...
 * FileId: XmZ2ozMxBnqF2wGgSM4DOvs+B37UgxFQ
 */
...
public class BusinessController extends BaseController {
    ...
    public ResponseEntity<?> save(Business business, HttpServletRequest request) {
        ...
        business.setDoctorId(business.getDoctorId());
    ...
    public ResponseEntity<?> update(Business business, Long id, Long businessRankId, Boolean unlock, HttpServletRequest request) {
        ...
        if (BooleanUtils.isTrue(pbusiness.getIsLocked()) && BooleanUtils.isTrue(unlock)) {
            ...
            businessService.update(business, "username", "encodedPassword", "balance", "frozenAmount", "businessDepositLogs", "businessCashs", "lastLoginIp", "lastLoginDate", "doctorId");
        } else {
            businessService.update(business, "username", "encodedPassword", "balance", "frozenAmount", "businessDepositLogs", "businessCashs", "isLocked", "lockDate", "lastLoginIp", "lastLoginDate", "doctorId");
        }
        return Results.OK;
    }
