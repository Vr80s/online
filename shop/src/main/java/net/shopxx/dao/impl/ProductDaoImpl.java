...
import net.shopxx.merge.service.impl.GoodsServiceImpl;
...
public class ProductDaoImpl extends BaseDaoImpl<Product, Long> implements ProductDao {
    ...
    public List<Map<String,Object>> findIdByCategoryId(ProductCategory productCategory) {
        ...
        List<BigInteger> resultList = entityManager.createNativeQuery(jpql).setParameter("categoryId", "%"+productCategory.getId()+"%")
        		.getResultList();
