...
public class Sku extends BaseEntity<Long> {
    ...
    public SkuVO getSkuVO() {
        ...
        skuVO.setSn(this.sn);
        skuVO.setCost(this.cost);
        skuVO.setAllocatedStock(this.allocatedStock);
        skuVO.setExchangePoint(this.exchangePoint);
        skuVO.setIsDefault(this.isDefault);
        skuVO.setMarketPrice(this.marketPrice);
        skuVO.setMaxCommission(this.maxCommission);
        skuVO.setPrice(this.price);
        skuVO.setRewardPoint(this.rewardPoint);
