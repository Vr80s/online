 ...
 */
@Entity
@Table(name = "Orders_delete")
public class OrderDelete extends BaseEntity<Long> {

	private static final long serialVersionUID = -1209482818598414208L;
	/**
	 * "订单锁"缓存名称
	 */
	...
	private OrderDelete.Status status;
	 ...
	 * @return 类型
	 */
	public OrderDelete.Type getType() {
		return type;
	}
	 ...
	 *            类型
	 */
	public void setType(OrderDelete.Type type) {
		this.type = type;
	}
	 ...
	 * @return 状态
	 */
	public OrderDelete.Status getStatus() {
		return status;
	}
	 ...
	 *            状态
	 */
	public void setStatus(OrderDelete.Status status) {
		this.status = status;
	}
	...
	public BigDecimal getAmountPayable() {
		if (!hasExpired() && !OrderDelete.Status.COMPLETED.equals(getStatus()) && !OrderDelete.Status.FAILED.equals(getStatus()) && !OrderDelete.Status.CANCELED.equals(getStatus()) && !OrderDelete.Status.DENIED.equals(getStatus())) {
	...
	public BigDecimal getAmountReceivable() {
		if (!hasExpired() && PaymentMethod.Type.CASH_ON_DELIVERY.equals(getPaymentMethodType()) && !OrderDelete.Status.COMPLETED.equals(getStatus()) && !OrderDelete.Status.FAILED.equals(getStatus()) && !OrderDelete.Status.CANCELED.equals(getStatus()) && !OrderDelete.Status.DENIED.equals(getStatus())) {
	...
	public BigDecimal getRefundableAmount() {
		if (hasExpired() || OrderDelete.Status.FAILED.equals(getStatus()) || OrderDelete.Status.CANCELED.equals(getStatus()) || OrderDelete.Status.DENIED.equals(getStatus())) {
		...
		if (OrderDelete.Status.COMPLETED.equals(getStatus())) {
	...
	public int getShippableQuantity() {
		if (!hasExpired() && OrderDelete.Status.PENDING_SHIPMENT.equals(getStatus())) {
	...
	public int getReturnableQuantity() {
		if ((!hasExpired() && OrderDelete.Status.FAILED.equals(getStatus()))) {
	...
	public boolean canDelete() {
		return OrderDelete.Status.CANCELED.equals(getStatus()) || OrderDelete.Status.FAILED.equals(getStatus()) || OrderDelete.Status.DENIED.equals(getStatus());
	}
