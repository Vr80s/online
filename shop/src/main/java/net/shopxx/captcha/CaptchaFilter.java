 ...
 * FileId: l9DcqipgQC7E9NGEoDRro5WKm9cR0nKS
 */
...
public class CaptchaFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        ...
        if (!isFreeSecret(request) && ArrayUtils.contains(setting.getCaptchaTypes(), getCaptchaType()) && !containsIgnoreCase(getNotRequireProtectionRequestMethods(), request.getMethod()) && !captchaService.isValid(captchaId, captcha)) {
    ...
    private boolean isFreeSecret(HttpServletRequest request) {
