 ...
 * FileId: CkGItUgq+i3uUnTyBJFt7WpsDAhD39fd
 */
...
public class AuthenticationFilter extends FormAuthenticationFilter {
    ...
    protected org.apache.shiro.authc.AuthenticationToken createToken(ServletRequest servletRequest, ServletResponse servletResponse) {
        ...
        UserAuthenticationToken userAuthenticationToken = new UserAuthenticationToken(getUserClass(), username, password, rememberMe, host);
        userAuthenticationToken.setFreeSecret(getFreeSecret(servletRequest));
        userAuthenticationToken.setFreeSecretKey(getFreeSecretKey(servletRequest));
    ...
    private boolean getFreeSecret(ServletRequest request) {
        String freeSecret = request.getParameter("freeSecret");
        return freeSecret != null && "true".equals(freeSecret);
    }

    private String getFreeSecretKey(ServletRequest request) {
        return request.getParameter("freeSecretKey");
    }
}