                ...
                <div class="panel-body">
                    ...
                    <div class="tab-content">
                        <div id="base" class="tab-pane active">
                            ...
                            <div class="form-group">
                                <label class="col-xs-3 col-sm-2 control-label"
                                       for="password">${message("Business.password")}:</label>
                                <div class="col-xs-9 col-sm-4">
                            ...
                            <div class="form-group">
                                <label class="col-xs-3 col-sm-2 control-label"
                                       for="rePassword">${message("admin.business.rePassword")}:</label>
                                <div class="col-xs-9 col-sm-4">
                            ...
                            <div class="form-group">
                                <label class="col-xs-3 col-sm-2 control-label item-required"
                                       for="email">${message("Business.email")}:</label>
                                <div class="col-xs-9 col-sm-4">
                                    <input id="email" name="email" class="form-control" type="text"
                                           value="${business.email}" maxlength="200">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-xs-3 col-sm-2 control-label item-required"
                                       for="mobile">${message("Business.mobile")}:</label>
                                <div class="col-xs-9 col-sm-4">
                                    <input id="mobile" name="mobile" class="form-control" type="text"
                                           value="${business.mobile}" maxlength="200">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-xs-3 col-sm-2 control-label"
                                ...
                                <div class="col-xs-9 col-sm-4">
                                    <select name="doctorId" class="selectpicker form-control" data-size="10" disabled>
                                        <option value="">选择医师</option>
                                    [#list doctors as doctor]
                                        <option value="${doctor.id}"
                                                [#if business.doctorId?? && business.doctorId ==doctor.id]selected[/#if]>${doctor.name}</option>
                                    [/#list]
                                    </select>
                                </div>
                            </div>
                        ...
                        [#if business.frozenAmount > 0]
                            <div class="form-group">
                                <label class="col-xs-3 col-sm-2 control-label">${message("Business.frozenAmount")}
                                    :</label>
                                <div class="col-xs-9 col-sm-4">
                                ...
                                <div class="col-xs-9 col-sm-4">
                                    <div class="checkbox checkbox-inline">
                                        ...
                                        <input id="isEnabled" name="isEnabled" type="checkbox"
                                               value="true"[#if business.isEnabled] checked[/#if]>
                                        <label for="isEnabled">${message("User.isEnabled")}</label>
                                    </div>
                                [#if business.isLocked]
                                    <div class="checkbox checkbox-inline">
                                        <input name="_unlock" type="hidden" value="false">
                                        <input id="unlock" name="unlock" type="checkbox"
                                               value="true"[#if !business.isLocked] checked[/#if]>
                    ...
                    [#if businessAttributes?has_content]
                        <div id="profile" class="tab-pane">
                            [#list businessAttributes as businessAttribute]
                                <div class="form-group">
                                    <label class="col-xs-3 col-sm-2 control-label[#if businessAttribute.isRequired] item-required[/#if]"
                                           for="businessAttribute_${businessAttribute.id}">${businessAttribute.name}
                                        :</label>
                                    [#if businessAttribute.type == "NAME"]
                                        <div class="col-xs-9 col-sm-4">
                                            <input id="businessAttribute_${businessAttribute.id}"
                                                   name="businessAttribute_${businessAttribute.id}" class="form-control"
                                                   type="text" value="${business.name}" maxlength="200">
                                        </div>
                                    [#elseif businessAttribute.type == "TEXT" || businessAttribute.type == "LICENSE_NUMBER" || businessAttribute.type == "LEGAL_PERSON" || businessAttribute.type == "ID_CARD" || businessAttribute.type == "PHONE" || businessAttribute.type == "ORGANIZATION_CODE" || businessAttribute.type == "IDENTIFICATION_NUMBER" || businessAttribute.type == "BANK_NAME" || businessAttribute.type == "BANK_ACCOUNT"]
                                        <div class="col-xs-9 col-sm-4">
                                            <input id="businessAttribute_${businessAttribute.id}"
                                                   name="businessAttribute_${businessAttribute.id}" class="form-control"
                                                   type="text" value="${business.getAttributeValue(businessAttribute)}"
                                                   maxlength="200">
                                        </div>
                                    [#elseif businessAttribute.type == "IMAGE" || businessAttribute.type == "LICENSE_IMAGE" || businessAttribute.type == "ID_CARD_IMAGE" || businessAttribute.type == "ORGANIZATION_IMAGE" || businessAttribute.type == "TAX_IMAGE"]
                                        <div class="col-xs-9 col-sm-4">
                                            <input name="businessAttribute_${businessAttribute.id}" type="hidden"
                                                   value="${business.getAttributeValue(businessAttribute)}"
                                                   data-provide="fileinput" data-file-type="IMAGE">
                                        </div>
                                    [#elseif businessAttribute.type == "SELECT"]
                                        <div class="col-xs-9 col-sm-4">
                                            <select id="businessAttribute_${businessAttribute.id}"
                                                    name="businessAttribute_${businessAttribute.id}"
                                                ...
                                                [#list businessAttribute.options as option]
                                                    <option value="${option}"[#if option == business.getAttributeValue(businessAttribute)]
                                    ...
                                    [#elseif businessAttribute.type == "CHECKBOX"]
                                        <div class="col-xs-9 col-sm-10">
                                            [#list businessAttribute.options as option]
                                                <div class="checkbox checkbox-inline">
                                                    <input id="${option}_${businessAttribute.id}"
                                                           name="businessAttribute_${businessAttribute.id}"
                                                           type="checkbox"
                                                           value="${option}"[#if (business.getAttributeValue(businessAttribute)?seq_contains(option))!]
                                                           checked[/#if]>
                                    ...
                                    [#elseif businessAttribute.type == "DATE"]
                                        <div class="col-xs-9 col-sm-4">
                                            <div class="input-group">
                                                <input name="businessAttribute_${businessAttribute.id}"
                                                       class="form-control" type="text"
                                                       value="[#if business.getAttributeValue(businessAttribute)??]${business.getAttributeValue(businessAttribute)}[/#if]"
