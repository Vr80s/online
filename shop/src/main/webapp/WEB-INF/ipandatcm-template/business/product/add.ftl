					...
					<div class="panel-body">
						...
						<div class="tab-content">
							<div id="base" class="tab-pane active">
								...
								<div class="form-group">
									<label class="col-xs-3 col-sm-2 control-label" for="keyword">111${message("Product.keyword")}:</label>
							...
							<div id="doctor" class="tab-pane">
								<div class="form-group">
									...
									<div class="col-xs-9 col-sm-4">
										...
										<div class="radio radio-inline">
											<input name="level" type="radio" checked="" value="5">
								...
								<div class="form-group">
									...
									<div class="col-xs-9 col-sm-4" title="" data-toggle="tooltip" data-original-title="若留空则由系统自动生成">
										<input id="doctorRecommentContent" name="recommentContent" class="form-control" type="text" maxlength="100">
									</div>
								</div>
						</div>
					</div>
