    ...
    [#escape x as x?js_string]
        <script>
            $().ready(function () {
                ...
                var freeSecretKey = getUrlParam("freeSecretKey");
                var username = getUrlParam("username");
                //免密码登陆
                if (freeSecretKey && username) {
                    $.ajax({
                        url: '/business/login',
                        method: 'POST',
                        data: {
            ...
            <div class="panel-body">
                    ...
                    <div class="form-group">
                        <div class="input-group">
                            ...
                            <input id="username" name="username" class="form-control" type="text" maxlength="200"
                                   placeholder="${message("business.login.usernamePlaceholder")}" autocomplete="off">
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="input-group">
                            ...
                            <input id="password" name="password" class="form-control" type="password" maxlength="200"
                                   placeholder="${message("business.login.passwordPlaceholder")}" autocomplete="off">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="input-group">
                            ...
                            <input id="captcha" name="captcha" class="captcha form-control" type="text" maxlength="4"
                                   placeholder="${message("common.captcha.name")}" autocomplete="off">
                ...
                [/#if]
                    <div class="form-group">
                        ...
                        <a class="text-white pull-right"
                           href="${base}/password/forgot?type=BUSINESS">${message("business.login.forgotPassword")}</a>
                    </div>
                    <div class="form-group">
                        <button class="btn btn-primary btn-lg btn-block"
                                type="submit">${message("business.login.submit")}</button>
                    </div>
                    <p>
                        <a class="text-orange"
                           href="${base}/business/register">${message("business.login.register")}</a>
                    </p>
                </form>
            </div>
        </div>
