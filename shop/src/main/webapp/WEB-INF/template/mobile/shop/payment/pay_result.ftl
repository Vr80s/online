...
<head>
    ...
    <title>${message("shop.payment.payResult")}</title>
...
<script type="text/javascript">
    $(function(){
        var href = "${ipandatcmUrl}/xcview/html/shop/payment_success.html?amount=${currency(paymentTransaction.amount, true, true)}&sn=${paymentTransaction.sn}&paymentPluginName=${paymentTransaction.paymentPluginName}";
//		alert(href);
