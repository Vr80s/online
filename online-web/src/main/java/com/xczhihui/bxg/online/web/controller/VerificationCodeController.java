...
public class VerificationCodeController extends OnlineBaseController {
    ...
    public ResponseObject sendmessage(String phone, int vtype, String vcode, HttpServletRequest req) {
        ...
        return ResponseObject.newSuccessResponseObject(service.addMessage(phone, VCodeType.getType(vtype)));
    }
    ...
    public ResponseObject sendEmail(String email, HttpServletRequest req) {
        return ResponseObject.newSuccessResponseObject(service.addMessage(email, VCodeType.FORGOT_PASSWORD));
    }
    ...
    public ResponseObject checkCode(String phone, String code, int vtype) {
        return ResponseObject.newSuccessResponseObject(service.checkCode(phone, VCodeType.getType(vtype), code));
    }
