		...
		<div class="protocol-shadow clearfix">
			<div class="pay-protocol-text">
				...
				<div class="pay-protocol-content">
					<p>欢迎使用熊猫中医云课堂服务，为保障用户权益，请用户在付费之前，详细阅读此服务协议（以下简称“本协议”）所有内容，<em class="indent">特别是加粗部分</em>。当用户点选“【我已经阅读并同意《熊猫中医云课堂-用户付费协议》】”，即表示用户同意并承诺遵守本协议。</p>
					...
					<h2>第二条 本协议的修订</h2>
					<p class="indent">熊猫中医云课堂有权对本协议进行调整或补充，并在熊猫中医云课堂平台（www.ipandatcm.com）公告。若用户继续使用熊猫中医云课堂服务的，则视为接受该协议的调整或补充，亦或用户有权终止使用该服务。</p>
					<h2>第三条 用户规则</h2>
					<p>1、用户可在熊猫中医云课堂平台上浏览已经发布的内容信息（包括但不限于收费课程信息等），如用户希望有偿获得该部分内容或服务，则用户需先登录或注册熊猫中医云课堂帐号或通过页面提示,选用其他第三方帐号进行登录。如用户选用其他第三方帐号进行登录的，用户应保证第三方帐号的稳定性、真实性以及可用性，如因第三方帐号原因（如第三方帐号被封号）致使用户无法登录熊猫中医云课堂的，用户应与第三方帐号的所属公司联系。用户在使用熊猫中医云课堂服务时登录的帐号是熊猫中医云课堂确认用户身份的唯一依据。</p>
					<p>2、用户理解并同意：熊猫中医云课堂平台提供有偿内容或服务实行先付款后使用的方式，用户及时、足额、合法的支付所需的款项是您使用该协议的有偿内容或服务的前提。</p>
					<p style="display:inline-block">3、用户理解并同意，熊猫中医云课堂平台发布的收费课程将采用整体购买的方式，即用户只需购买一次，就可以学习该课程所有已发布或即将发布的课时。<em class="indent">关于已购买的付费课程视频资源使用时效说明如下：</em>
					...
					<p class="indent">4、用户知悉并同意，用户无权对已购买的课程进行出售、转让、许可或其他方式使除用户自己以外的第三方（包括但不限于自然人、法人或其他组织）使用其已购买的课程。若用户违反本条规定，则熊猫中医云课堂有权视情况采取如下措施：
					...
					<p>6、用户应保管好自己的帐号和密码（包括但不限于：邮箱帐号），如因用户未保管好自己的帐号和密码而对自己、熊猫中医云课堂造成损害的，用户将负全部责任。另外，用户应对用户帐号中的所有活动和事件负全责。用户可随时改变帐号和密码。用户同意若发现有非法使用用户的帐号或出现安全漏洞的情况，立即通告熊猫中医云课堂，熊猫中医云课堂将会尽力予以妥善解决。</p>
					<h2>第四条  其他约定</h2>
