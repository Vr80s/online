...
{"item_code":"460400","item_name":"五指山市"},
{"item_code":"460500","item_name":"琼海市"},
{"item_code":"460600","item_name":"儋州市"},
{"item_code":"460700","item_name":"文昌市"},
{"item_code":"460800","item_name":"万宁市"},
{"item_code":"460900","item_name":"东方市"},
{"item_code":"461000","item_name":"定安县"},
{"item_code":"461100","item_name":"屯昌县"},
{"item_code":"461200","item_name":"澄迈县"},
{"item_code":"461300","item_name":"临高县"},
{"item_code":"461400","item_name":"白沙黎族自治县"},
{"item_code":"461500","item_name":"昌江黎族自治县"},
{"item_code":"461600","item_name":"乐东黎族自治县"},
{"item_code":"461700","item_name":"陵水黎族自治县"},
{"item_code":"461800","item_name":"保亭黎族苗族自治县"},
{"item_code":"461900","item_name":"琼中黎族苗族自治县"},
...
{"item_code":"460301","item_name":"西沙群岛"},
{"item_code":"460302","item_name":"南沙群岛"},
{"item_code":"460303","item_name":"中沙群岛的岛礁及其海域"},
...
function doProvAndCityRelation() {
  ...
  $.each(cityJson,
    function(i, val) {
      if (val.item_code.substr(0, 2) == $("#choosePro").val().substr(0, 2) && val.item_code.substr(2, 4) != '0000' && val.item_code.substr(4, 2) == '00') {
        sb.append("<option value='" + val.item_code + "'>" + val.item_name + "</option>");
        if(cityVal == ""){
...
//
      ...
      if (val.item_code.substr(0, 2) == $("#edit_province").val().substr(0, 2) && val.item_code.substr(2, 4) != '0000' && val.item_code.substr(4, 2) == '00') {
        ...
        if(cityVal == ""){
        	cityVal = val.item_code;
       	 	...
       	 	$("#edit_realCitys").val(val.item_name);
        }
      }
    });
  ...
  if(county!=null && county!=undefined){
      ...
      // 添加标识flag 用来取出第一个区／县的option 防止拿到null
      var flag = true;
	  ...
	  $.each(cityJson, function(i, val) {
	      if (cityVal == '110100' || cityVal == "120100" || cityVal == "310100" || cityVal == "500100") {
	        if (val.item_code.substr(0, 3) == cityVal.substr(0, 3) && val.item_code.substr(4, 2) != '00') {
	          ...
	          if(flag){
                  $('#edit_realCounty').val(val.item_name);
                  flag = false;
              }
